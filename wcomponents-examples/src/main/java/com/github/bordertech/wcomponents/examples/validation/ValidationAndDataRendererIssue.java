...
/**
 * This class demonstrates a problem with binding a WDataRenderer to a data
 * bean that is unable to store incorrectly typed values.
 * In this case, the problem attribute is java.util.Date. If you enter a
 * value such as "44 Aug 2008" into the WDateField, then there is a problem!
 * 
