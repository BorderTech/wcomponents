...
/**
 * Examples of properties of {@link WTab}. For properties of {@link WTabSet} see
 * {@link WTabSetExample}.
 *
 * @author exbtma
 */
public class WTabExample extends WPanel {
	...
	private static final class SampleTabSet extends WTabSet {
		...
		/**
		 * rubbish shortcut to create a tabset with a particular tab open. This is just to show how
		 * to default to a tab other than the first.
		 *
