...
/**
 * In this example the {@link WDropdownTriggerActionExample} component is made ajax aware. The state
 * dropdown becomes an ajax trigger that updates the region and suburb dropdowns (ajax targets). The
 * region dropdown becomes an ajax trigger that updates the suburb dropdown. No longer is a full
 * page reload required for the dropdown updates.
 *
