 ...
 * <p>
 * The UI will display a "warning" message to the user that their session will soon expire. Once the
 * session timeout has elapsed, an "expired" message will be displayed to the user.
 * </p>
 * <p>
