...
/**
 * This example shows use of a {@link WDataTable}, with a two-dimensional array of data and
 * rendering of dynamic content using the WContentHelperServlet. The data will be held in the user's
 * session.
 *
