...
/**
 * In this example the button from {@link WImageExample} is made an AJAX trigger. The image is an
 * AJAX target. So rather than refreshing the whole page to change the image, only the image is
 * replaced via the AJAX response.
 *
