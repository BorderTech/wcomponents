...
public class MenuBarExample extends WContainer
{
    ...
    public MenuBarExample()
    {
        ...
        add(new WStyledText("Selected item: ", WStyledText.Type.EMPHASISED));
        add(selectedMenuText);
        add(buildMenuBar(selectedMenuText));
    }

    public MenuBarExample(WText selectedMenuText)
    {
        barMenu = buildMenuBar(selectedMenuText);
    }

    /**
     * Get the Bar menu used in this example for use in other examples.
     * @return  a menu bar.
     */
