...
public class RadioButtonExample_Test extends WComponentExamplesTestCase {
	...
	public void testExample() {
		...
		Assert.assertFalse("First radioButton should be unselected",
				driver.findWRadioButton(byWComponentPath("WRadioButton[0]")).isSelected());
		Assert.assertTrue("First radioButton should be enabled",
				driver.findWRadioButton(byWComponentPath("WRadioButton[0]")).isEnabled());

		Assert.assertTrue("Second radioButton should be selected",
				driver.findWRadioButton(byWComponentPath("WRadioButton[1]")).isSelected());
		Assert.assertTrue("Second radioButton should be enabled",
				driver.findWRadioButton(byWComponentPath("WRadioButton[1]")).isEnabled());

		Assert.assertFalse("Third radioButton should be unselected",
				driver.findWRadioButton(byWComponentPath("WRadioButton[2]")).isSelected());
		Assert.assertFalse("Third radioButton should be disabled",
				driver.findWRadioButton(byWComponentPath("WRadioButton[2]")).isEnabled());
	}
}
