...
import com.github.openborders.render.webxml.WApplicationRenderer;
...
public class WApplicationRenderer_Test extends AbstractWebXmlRendererTestCase
{
    ...
    public void testRenderedFormatWithHiddenFields() throws XpathException, IOException, SAXException
    {
        ...
        Map<String, String> hiddenParameters = new HashMap<String, String>();
    ...
    public void testRendererTracking() throws IOException, SAXException, XpathException
    {
        ...
        config.setProperty("wcomponent.tracking.clientid", "CID");         
        config.setProperty("wcomponent.tracking.applicationname", "APPL");
        config.setProperty("wcomponent.tracking.cookiedomain", "CD");
        config.setProperty("wcomponent.tracking.datacollectiondomain", "DCD");
