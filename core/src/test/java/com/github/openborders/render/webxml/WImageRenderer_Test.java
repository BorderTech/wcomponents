...
import com.github.openborders.MockImage;
import com.github.openborders.WImage;
import com.github.openborders.WebUtilities;
import com.github.openborders.render.webxml.WImageRenderer;
...
public class WImageRenderer_Test extends AbstractWebXmlRendererTestCase
{
    ...
    /**
     * We need to match urls which include a random no-cache value.
     * e.g. <pre>unknown?no-cache=1994285646-4&target_id=L&s=0</pre>
     *
