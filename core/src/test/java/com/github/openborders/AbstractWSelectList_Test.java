...
import com.github.openborders.AbstractWSelectList;
...
import com.github.openborders.TestLookupTable.YesNoTable;
...
public class AbstractWSelectList_Test extends AbstractWComponentTestCase
{
    ...
    public static void setUp()
    {
        ...
        overrides.setProperty("wcomponent.integrity.terminate.mode", "true");
