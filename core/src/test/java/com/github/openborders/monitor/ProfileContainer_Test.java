...
public class ProfileContainer_Test extends AbstractWComponentTestCase
{
    ...
    public void testAfterPaint()
    {
        ...
        String profileLine31 = PROFILER_LINE3.replaceAll("<<CLASS_NAME>>", "com.github.openborders.WButton");
        String profileLine32 = PROFILER_LINE3.replaceAll("<<CLASS_NAME>>",
                                                         "com.github.openborders.monitor.ProfileContainer");
        String profileLine33 = PROFILER_LINE3.replaceAll("<<CLASS_NAME>>", "com.github.openborders.WLabel");
