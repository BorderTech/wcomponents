...
import com.github.openborders.HeadersImpl;
...
public class HeadersImpl_Test
{
    ...
    public void testAddHeadLine() 
    {
        ...
        Assert.assertNull("Should not have any JS headers", headers.getHeadLines(Headers.JAVASCRIPT_HEADLINE));
        Assert.assertNull("Should not have any CSS headers", headers.getHeadLines(Headers.CSS_HEADLINE));
    ...
    public void testAddUniqueHeadLine() 
    {
        ...
        headers.addUniqueHeadLine(line1);
        Assert.assertEquals("Untyped headers should not have changed", untypedHeaders, headers.getHeadLines(Headers.UNTYPED_HEADLINE));
        Assert.assertNull("Should not have any JS headers", headers.getHeadLines(Headers.JAVASCRIPT_HEADLINE));
        Assert.assertNull("Should not have any CSS headers", headers.getHeadLines(Headers.CSS_HEADLINE));
    ...
    public void testSetContentType()
    {
        ...
        HeadersImpl headers = new HeadersImpl();
        Assert.assertEquals("Default content type should be text/html", "text/html", headers.getContentType());
    ...
    public void testReset()
    {
        ...
        headers.reset();
        Assert.assertEquals("Content type should be text/html after reset", "text/html", headers.getContentType());
