...
import com.github.openborders.AbstractWMultiSelectList;
import com.github.openborders.OptionGroup;
import com.github.openborders.WBeanContainer;
import com.github.openborders.TestLookupTable.DayOfWeekTable;
...
public class AbstractWMultiSelectList_Test extends AbstractWComponentTestCase
{
    ...
    public void testGetValueWithNoOptionsNothingSelected()
    {
        ...
        // Empty Options
        multi = new MyWMultiSelectList(new ArrayList<Object>(), true);
        ...
        // Empty Options
        multi = new MyWMultiSelectList(new ArrayList<Object>(), false);
    ...
    {
        List<String> userTextList = new ArrayList<String>(Arrays.asList("USERTEXT"));
        List<String> userTextList2 = new ArrayList<String>(Arrays.asList("USERTEXT2"));
    ...
    public void testValidateMaxSelect()
    {
        ...
        diags = new ArrayList<Diagnostic>();
        multi.validate(diags);
