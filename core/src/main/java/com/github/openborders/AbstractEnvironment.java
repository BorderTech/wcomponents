...
public abstract class AbstractEnvironment implements Environment
{
    ...
    /** 
     * The base url. 
     * e.g. for <code>"http://localhost:1234/bar/something?a=b"</code>, 
     * it would be <code>"http://localhost/bar"</code>. 
     */
    private String baseUrl;
    
    /** 
     * The host free part of the base url.
     * e.g. for <code>"http://localhost:1234/bar/something?a=b"</code>, 
     * it would be <code>"bar"</code>. 
     */
    ...
    /**
     * Constructs the path to one of the various helper servlets. 
     * This is used by the more specific getXXXPath methods.
     * 
     ...
     * The applicationId must not contain {@link WComponent#IDNAME_SEPERATOR}.
     * 
     * @param appId
     *            the appId to set.
