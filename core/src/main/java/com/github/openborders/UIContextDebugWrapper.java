...
/**
 * This class can be used to dump the contents of a UIContext object
...
public class UIContextDebugWrapper
{
     ...
     * Also tally up how many are storing data unnecessarily.
     * Also tally how many different top components are referenced by the components stored in the UIContext.
     * 
    ...
    public String toString()
    {
        ...
        try
        {
            Set components = uic.getComponents();
            
            // Variables that will contain the stats collected.
            GroupData dataOverall = new GroupData();
            Map<String, GroupData> tallyByClass = new TreeMap<String, GroupData>();
            Set<WComponent> topComponents = new HashSet<WComponent>();
    ...
    {
        /** 
         * The count of instances of the particular WComponent
         * class with a component model in the context/session. 
         */
        public int total = 0;
