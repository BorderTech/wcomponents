 ...
 * The API is loosely based on Swing's DefaultMutableTreeNode. 
 * 
...
public interface TreeNode
{
     ...
     * 
     * @param otherNode the node to check.
     * @return true if <code>otherNode</code> is in the same tree as this node; false 
     *         if <code>otherNode</code> is null
     */
