...
import com.github.openborders.layout.LayoutManager;
...
public class WPanel extends WContainer implements AjaxTarget, SubordinateTarget, Marginable, DropZone
{
    ...
    /** {@inheritDoc} */
    @Override
    public void setMargin(final com.github.openborders.Margin margin)
    {
    ...
    /** {@inheritDoc} */
    @Override
    public com.github.openborders.Margin getMargin()
    {
    ...
    public static class PanelModel extends BeanAndProviderBoundComponentModel
    {
        ...
        private com.github.openborders.Margin margin;
