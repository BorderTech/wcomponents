package com.github.openborders.test.util; 
 ...
 * @since 1.0.0
 * @deprecated use com.github.openborders.util.TreeUtil
 */
@Deprecated
public final class TreeUtil
{
    ...
    {
        return com.github.openborders.util.TreeUtil.collateVisibles(comp);
    }
    ...
    {
        return com.github.openborders.util.TreeUtil.getRoot(uic, comp);
    }
    ...
    {
        return com.github.openborders.util.TreeUtil.getComponentWithId(root, id);
    }
    ...
    {
        return com.github.openborders.util.TreeUtil.getContextForId(root, id);
    }
    ...
    {
        com.github.openborders.util.TreeUtil.traverse(node, visitor);
    }
    ...
    {        
        com.github.openborders.util.TreeUtil.traverseVisible(node, visitor);
    }
    ...
    {
        return com.github.openborders.util.TreeUtil.findWComponents(component, path);
    }
    ...
    {
        return com.github.openborders.util.TreeUtil.findWComponent(component, path);
    }
    
    /**
     * An implementation of WComponentTreeVisitor which can return a result.
     */
    public abstract static class AbstractTreeVisitorWithResult<T> extends com.github.openborders.util.TreeUtil.AbstractTreeVisitorWithResult
    {
    }
}
