package com.github.dibp.wcomponents.test.util; 
 ...
 * @since 1.0.0
 * @deprecated use com.github.dibp.wcomponents.util.TreeUtil
 */
@Deprecated
public final class TreeUtil
{
    ...
    {
        return com.github.dibp.wcomponents.util.TreeUtil.collateVisibles(comp);
    }
    ...
    {
        return com.github.dibp.wcomponents.util.TreeUtil.getRoot(uic, comp);
    }
    ...
    {
        return com.github.dibp.wcomponents.util.TreeUtil.getComponentWithId(root, id);
    }
    ...
    {
        return com.github.dibp.wcomponents.util.TreeUtil.getContextForId(root, id);
    }
    ...
    {
        com.github.dibp.wcomponents.util.TreeUtil.traverse(node, visitor);
    }
    ...
    {        
        com.github.dibp.wcomponents.util.TreeUtil.traverseVisible(node, visitor);
    }
    ...
    {
        return com.github.dibp.wcomponents.util.TreeUtil.findWComponents(component, path);
    }
    ...
    {
        return com.github.dibp.wcomponents.util.TreeUtil.findWComponent(component, path);
    }
    
    /**
     * An implementation of WComponentTreeVisitor which can return a result.
     */
    public abstract static class AbstractTreeVisitorWithResult<T> extends com.github.dibp.wcomponents.util.TreeUtil.AbstractTreeVisitorWithResult
    {
    }
}
