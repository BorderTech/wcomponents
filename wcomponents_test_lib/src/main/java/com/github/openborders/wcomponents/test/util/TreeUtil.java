package com.github.openborders.wcomponents.test.util; 
 ...
 * @since 1.0.0
 * @deprecated use com.github.openborders.wcomponents.util.TreeUtil
 */
@Deprecated
public final class TreeUtil
{
    ...
    {
        return com.github.openborders.wcomponents.util.TreeUtil.collateVisibles(comp);
    }
    ...
    {
        return com.github.openborders.wcomponents.util.TreeUtil.getRoot(uic, comp);
    }
    ...
    {
        return com.github.openborders.wcomponents.util.TreeUtil.getComponentWithId(root, id);
    }
    ...
    {
        return com.github.openborders.wcomponents.util.TreeUtil.getContextForId(root, id);
    }
    ...
    {
        com.github.openborders.wcomponents.util.TreeUtil.traverse(node, visitor);
    }
    ...
    {        
        com.github.openborders.wcomponents.util.TreeUtil.traverseVisible(node, visitor);
    }
    ...
    {
        return com.github.openborders.wcomponents.util.TreeUtil.findWComponents(component, path);
    }
    ...
    {
        return com.github.openborders.wcomponents.util.TreeUtil.findWComponent(component, path);
    }
    
    /**
     * An implementation of WComponentTreeVisitor which can return a result.
     */
    public abstract static class AbstractTreeVisitorWithResult<T> extends com.github.openborders.wcomponents.util.TreeUtil.AbstractTreeVisitorWithResult
    {
    }
}
