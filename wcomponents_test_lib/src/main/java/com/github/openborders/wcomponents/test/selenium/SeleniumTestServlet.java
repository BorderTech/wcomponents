...
import com.github.openborders.wcomponents.lde.TestServlet;
...
public class SeleniumTestServlet extends TestServlet
{
    ...
    public void run() throws Exception
    {
        ...
        Config.getInstance().setProperty("wcomponent.lde.server.port", "0");
        super.run();
    }
    ...
    private static final class ScriptInterceptor extends InterceptorComponent
    {
        ...
        public void paint(final RenderContext renderContext)
        {
            ...
            else if (renderContext instanceof WebXmlRenderContext)
            {
                ...
                try
                {
                    InputStream stream = getClass().getResourceAsStream("/com/github/openborders/wcomponents/test/selenium/" + scriptRequested);
