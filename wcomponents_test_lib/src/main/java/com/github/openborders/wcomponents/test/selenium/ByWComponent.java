...
/**
 * An implementation of By which can find HTML elements which correspond to (most) 
...
public class ByWComponent extends By
{
     ...
     * given context. If searching for a repeated component, the <code>context</code>
     * should be the row context for the row you want to return.
     * 
