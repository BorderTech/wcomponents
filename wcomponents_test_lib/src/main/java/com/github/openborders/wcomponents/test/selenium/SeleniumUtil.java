...
public final class SeleniumUtil 
{
     ...
     * A search is performed under each search result for an element with the given value.
     * Existing results are either replaced or removed, depending on whether a match was found. 
     * 
