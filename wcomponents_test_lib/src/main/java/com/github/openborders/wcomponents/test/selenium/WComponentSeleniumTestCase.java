package com.github.openborders.wcomponents.test.selenium;
...
import com.github.openborders.wcomponents.test.WComponentTestCase;
...
public class WComponentSeleniumTestCase extends WComponentTestCase
{
    ...
    /**
     * How long to implicitly wait for elements to appear, in milliseconds.
     * If an element does not appear after this delay, Selenium will throw a NoSuchElementException.
     */
    ...
    /**
     * Called before each test method to refresh the user
     * session and launch a new browser.
     */
    @Before
    public void setUp()
    {
    ...
    /**
     * Called after each test method to clear the user
     * session and close the browser window.
     */
    @After
    ...
    /**
     * Called once before any test methods, to start the Selenium test LDE
     ...
     * Subclasses should use this to obtain a driver instance for their tests.
     * Note that the driver is disposed of between tests, so it should not be
    ...
    /**
     * Creates a driver to use during testing.
     * Subclasses may use this to change the browser
    ...
    /**
     * Extension of InternetExplorerDriver to work around Selenium
     * not waiting for the theme and skin javascript to complete.
     */
    ...
    /**
     * Extension of FirefoxDriver to work around Selenium
     * not waiting for the theme and skin javascript to complete.
     */
    ...
    /**
     * Extension of ChromeDriver to work around Selenium
     * not waiting for the theme and skin javascript to complete.
     */
    ...
    /**
     * A Wrapper for a web-element to provide developers some further insulation
     * from theme and skin changes.
     *
     * This also contains a work-around for Selenium not waiting for javascript
     * form submission. A delay is inserted after each form control is used.
     */
    private static final class WebElementWrapper implements WebElement
    {
        /**
         * Sleep delay after using a control, in milliseconds.
         * This only needs to sleep for as long as themes take to
         ...
         */
        public WebElementWrapper(final WebDriver driver, final WebElement element)
        {
         ...
         */
        public WebElementWrapper(final WebDriver driver, final WebElement element, final Class<? extends WComponent> componentClass)
        {
            this.driver = driver;
