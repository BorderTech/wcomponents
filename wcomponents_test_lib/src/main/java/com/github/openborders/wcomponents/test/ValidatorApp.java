 ...
 * The ValidatorApp should be run from the command-line.
 *
...
public final class ValidatorApp extends JFrame
{
    ...
    /**
     * Validates the XML contained in the input text area
     * and displays the errors (if any) in the output text area.
     */
    ...
    {
        /**
         * The backing context, used for resolving namespaces which
        ...
        public String getNamespaceURI(final String prefix)
        {
            if ("ui".equals(prefix))
            {
                return "https://github.com/openborders/wcomponents/namespace/ui/v1.0";
            }
