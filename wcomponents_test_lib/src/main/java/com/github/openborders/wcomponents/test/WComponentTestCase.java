package com.github.openborders.wcomponents.test;
 ...
 * features useful for the testing of WComponents. 
 * 
...
public abstract class WComponentTestCase
{
     ...
     * By default, this returns the default theme in use, but individual
     * tests can override this to use a specific theme.
     * 
     ...
     * The default implementation is to create and use a single context,
     * but subclasses can change this behaviour if they wish.
     * 
