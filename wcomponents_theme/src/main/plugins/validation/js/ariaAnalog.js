 ...
 *
 * @module ${validation.core.path.name}/ariaAnalog
...
define(["wc/dom/group",
	...
	/** @param group wc/dom/group @param shed wc/dom/shed @param validationManager ${validation.core.path.name}/validationManager @param isComplete ${validation.core.path.name}/isComplete @ignore */
	function(group, shed, validationManager, isComplete) {
		 ...
		 * @constructor
		 * @abstract
		 * @alias module:${validation.core.path.name}/ariaAnalog~ValidationAriaAnalog
		 * @private
		 */
		...
		var /** @alias module:${validation.core.path.name}/ariaAnalog */ instance = new ValidationAriaAnalog();
