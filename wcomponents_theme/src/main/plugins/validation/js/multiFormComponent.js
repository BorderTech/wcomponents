 ...
 *
 * @module ${validation.core.path.name}/multiFormComponent
...
define(["wc/dom/attribute",
	...
	function(attribute, event, initialise, Widget, i18n, multiFormComponent, unique, getFirstLabelForElement, sprintf, required, validationManager) {
		...
		/**
		 * @constructor
		 * @alias module:${validation.core.path.name}/multiFormComponent~ValidationMultiFormComponent
		 * @private
		 */
		function ValidationMultiFormComponent() {
			 ...
			 * @function module:${validation.core.path.name}/multiFormComponent.initialise
			 ...
			 * @function module:${validation.core.path.name}/multiFormComponent.postInit
			 */
		...
		var /** @alias module:${validation.core.path.name}/multiFormComponent */ instance = new ValidationMultiFormComponent();
