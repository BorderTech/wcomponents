...
public class SearchScreen extends WPanel {
    ...
    public SearchScreen() {
        ...
        searchButton.setAjaxTarget(searchResults);
    }
     ...
     */
    private final class SearchCriteriaPanel extends WPanel {
        /**
        ...
        public SearchCriteriaPanel() {
			...
			add(new WHeading(HeadingLevel.H2, "Customer search"));
			...
			fieldLayout.addField((WLabel) null, searchButton);

			setDefaultSubmitButton(searchButton);
        }
    }
    ...
    private static final class SearchResultsPanel extends WPanel {
        ...
        public SearchResultsPanel() {
			...
			add(new WHeading(HeadingLevel.H2, "Search results"));
            add(resultsTable);
