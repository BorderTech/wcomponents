	...
	function(registerSuite, assert, testutils, event) {
		...
		registerSuite({
			...
			testEventWithHide: function() {
				_withEventHelper("subscriberDiv1", controller.events.HIDE);
			},
			...
			testEventWithExpand: function() {
				_withEventHelper("exp1", controller.actions.EXPAND);
			},
			testEventWithCollapse: function() {
				_withEventHelper("exp2", controller.actions.COLLAPSE);
			},
			...
			testEventWithMandatory: function() {
				_withEventHelper("inp7", controller.actions.MANDATORY);
			},
			testEventWithOptional: function() {
				_withEventHelper("inp8", controller.actions.OPTIONAL);
			},
