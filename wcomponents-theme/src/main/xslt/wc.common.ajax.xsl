<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ui="https://github.com/bordertech/wcomponents/namespace/ui/v1.0" 
	...
	<!--
		...
		Helper templates and keys for common ajax markup. These templates are accessibility helpers and the accessibility forms the basis for the
		functionality.

		Key to find all ajaxTriggers to determine if a control is an ajaxTrigger so that it can be marked up with appropriate WAI-ARIA properties.
	-->
	<xsl:key name="triggerKey" match="//ui:ajaxtrigger" use="@triggerId" />

	<!-- Key to find all ajax targets to determine if a control is an ajaxTarget so that it can be marked up with appropriate WAI-ARIA properties.
	-->
