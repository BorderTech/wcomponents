...
(function(){
	...
	if (SystemJS &amp;&amp; SystemJS.config) SystemJS.config({ "wc/fix/html5Fix_ie8": { elements: el } });
	else if (require &amp;&amp; require.config) require.config["wc/fix/html5Fix_ie8"] = { elements: el };
