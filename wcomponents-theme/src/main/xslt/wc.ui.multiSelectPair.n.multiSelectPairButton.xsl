<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ui="https://github.com/bordertech/wcomponents/namespace/ui/v1.0" xmlns:html="http://www.w3.org/1999/xhtml" version="1.0">
	...
	<xsl:template name="multiSelectPairButton">
		...
		<button type="button" value="{$value}" title="{$buttonText}" class="wc_btn_icon" aria-controls="{concat(@id, '${wc.ui.multiSelectPair.id.suffix.available}',' ',@id, '${wc.ui.multiSelectPair.id.suffix.selected}')}">
