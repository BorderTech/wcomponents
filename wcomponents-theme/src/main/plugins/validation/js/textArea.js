 ...
 *
 * @module ${validation.core.path.name}/textArea
...
define(["wc/dom/attribute",
	...
	function(attribute, event, initialise, Widget, i18n, sprintf, required, validationManager, getFirstLabelForElement, textArea) {
		...
		/**
		 * @constructor
		 * @alias module:${validation.core.path.name}/textArea~ValidationTextArea
		 * @private
		 */
		function ValidationTextArea() {
			...
			*/
			 ...
			 * @function module:${validation.core.path.name}/textArea.initialise
			 ...
			 *
			 * @function module:${validation.core.path.name}/textArea.postInit
			 */
		...
		var /** @alias module:${validation.core.path.name}/textArea */ instance = new ValidationTextArea();
