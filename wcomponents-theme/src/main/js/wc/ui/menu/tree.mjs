...
/**
 *
 * @param {string[]} keys An array of KeyBoardEven code and or key properties.
 * @return {function}
 */
...
class Tree extends AbstractMenu {
	 ...
	 */
	_select(item, silent, SHIFT, CTRL) {
	 ...
	 */
	_getBranchExpandableElement (item) {
		if (!item) {
