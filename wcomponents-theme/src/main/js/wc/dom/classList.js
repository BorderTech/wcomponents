...
define(["wc/has"], /** @param has wc/has @ignore */function(has) {
	...
	var global = window,
		...
		nativeClassList = (global.document && (classListProp in (global.document.createElement("div")))),
		trim = /^\s+|\s+$/g,
		whiteSpaceRe = /\s+/;
	...
	return new ClassList(classListGetter, nativeClassList);
});
 ...
 * @ignore
 */
function ClassList($classListGetter, nativeClassList) {
	var $this = this;
