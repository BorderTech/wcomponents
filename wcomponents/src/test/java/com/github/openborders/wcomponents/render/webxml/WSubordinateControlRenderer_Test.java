...
import com.github.openborders.wcomponents.SubordinateTrigger;
...
import com.github.openborders.wcomponents.subordinate.And;
import com.github.openborders.wcomponents.subordinate.Condition;
import com.github.openborders.wcomponents.subordinate.Disable;
import com.github.openborders.wcomponents.subordinate.DisableInGroup;
import com.github.openborders.wcomponents.subordinate.Enable;
import com.github.openborders.wcomponents.subordinate.EnableInGroup;
import com.github.openborders.wcomponents.subordinate.Equal;
import com.github.openborders.wcomponents.subordinate.GreaterThan;
import com.github.openborders.wcomponents.subordinate.GreaterThanOrEqual;
import com.github.openborders.wcomponents.subordinate.Hide;
import com.github.openborders.wcomponents.subordinate.HideInGroup;
import com.github.openborders.wcomponents.subordinate.LessThan;
import com.github.openborders.wcomponents.subordinate.LessThanOrEqual;
import com.github.openborders.wcomponents.subordinate.Mandatory;
import com.github.openborders.wcomponents.subordinate.Match;
import com.github.openborders.wcomponents.subordinate.NotEqual;
import com.github.openborders.wcomponents.subordinate.Optional;
import com.github.openborders.wcomponents.subordinate.Or;
import com.github.openborders.wcomponents.subordinate.Rule;
import com.github.openborders.wcomponents.subordinate.Show;
import com.github.openborders.wcomponents.subordinate.ShowInGroup;
...
public class WSubordinateControlRenderer_Test extends AbstractWebXmlRendererTestCase
{
    ...
    public void testRendererCorrectlyConfigured()
    {
        ...
        Assert.assertTrue("Incorrect renderer supplied", getWebXmlRenderer(control) instanceof WSubordinateControlRenderer);
    }
    ...
    public void testBasicConditionWithGroup() throws IOException, SAXException, XpathException
    {
        ...
        WComponentGroup<SubordinateTarget> group1 = new WComponentGroup<SubordinateTarget>();
    ...
    public void testShowHideActions() throws IOException, SAXException, XpathException
    {
        ...
        assertXpathEvaluatesTo(group1.getId(), "//ui:subordinate/ui:onTrue[position()=2]/ui:target/@groupId",
                               root);
        ...
        assertXpathEvaluatesTo(group1.getId(), "//ui:subordinate/ui:onFalse[position()=2]/ui:target/@groupId",
                               root);
    ...
    public void testOrCondition() throws IOException, SAXException, XpathException
    {
        ...
        assertXpathEvaluatesTo(condTrigger1.getId(), "//ui:subordinate/ui:or/ui:condition[position()=1]/@controller",
                               root);
        assertXpathEvaluatesTo(condTrigger2.getId(), "//ui:subordinate/ui:or/ui:condition[position()=2]/@controller",
                               root);
        assertXpathEvaluatesTo(condTrigger3.getId(), "//ui:subordinate/ui:or/ui:condition[position()=3]/@controller",
                               root);
        // Check action target
        assertXpathEvaluatesTo("true", "//ui:textField/@hidden", root);
