...
public class WFieldRenderer_Test extends AbstractWebXmlRendererTestCase
{
    ...
    {
        WField field = new com.github.openborders.wcomponents.WFieldLayout().addField("test1", new WTextArea());
    ...
    public void testDoPaintBasic() throws IOException, SAXException, XpathException
    {
        ...
        com.github.openborders.wcomponents.WFieldLayout test = new com.github.openborders.wcomponents.WFieldLayout();
