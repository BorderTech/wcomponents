...
import com.github.openborders.wcomponents.SimpleTableDataModel;
import com.github.openborders.wcomponents.TableDataModel;
...
import com.github.openborders.wcomponents.WDataTable.ExpandMode;
import com.github.openborders.wcomponents.WDataTable.PaginationMode;
import com.github.openborders.wcomponents.WDataTable.SortMode;
...
public class WDataTableRenderer_Test extends AbstractWebXmlRendererTestCase
{
    ...
    /**
     * test doPaint - no caption, no summary, default tableType TABLE. with default stripingType NONE and default
     * SeperatorType NONE
     */
    @Test
    ...
    /**
     * test doPaint - no caption, no summary, default tableType TABLE. with stripingType=ROWS and
    ...
    /**
     * test doPaint - no caption, no summary, default tableType TABLE. with default stripingType=COLUMNS and
    ...
    /**
     * test doPaint with summary and caption set and table type HIERARCHIC. checking table columns and table data
     * contents
     */
    @Test
    public void testDoPaintAttributesAndContent() throws IOException, SAXException, XpathException
    {
        ...
        for (int i = 0; i < tableModel.getRowCount(); i++)
        {
            ...
            {
                assertXpathEvaluatesTo((String) tableModel.getValueAt(i, j), "//ui:table/ui:tbody/ui:tr[" + (i + 1)
    ...
    public void testDoPaintPaginatedClient() throws IOException, SAXException, XpathException
    {
        ...
        assertXpathEvaluatesTo((new Integer(tableModel.getRowCount())).toString(), "//ui:table/ui:pagination/@rows",
                               component);
    ...
    /**
     * test doPaint paginationMode=SERVER.
     */
    @Test
    ...
    /**
     * test doPaint selectMode=multiple selectAll=Control - submitOnRowSelect=true, groupName Set.
     */
    @Test
    ...
    /**
     * test doPaint - expandMode SERVER
     */
    @Test
    ...
    /**
     * test doPaint - sortable - sortMode SERVER
     */
    @Test
    ...
    /**
     * test doPaint - sortable - sortMode DYNAMIC. with simulated client side setting of sortColindex and descending
     * mode
     */
    @Test
    ...
    public void testDoPaintTableActions() throws IOException, SAXException, XpathException
    {
        ...
        assertXpathEvaluatesTo(TEST_ACTION_ONE, "//ui:table/ui:actions/ui:action[1]/ui:button", component);
    ...
    public void testDoPaintTableActionsWithConstraints() throws IOException, SAXException, XpathException
    {
        ...
        component.addActionConstraint(buttonOne, new ActionConstraint(minSelectedRowCount1, maxSelectedRowCount1,
                                                                           true, message1));
        component.addActionConstraint(buttonTwo, new ActionConstraint(minSelectedRowCount2, maxSelectedRowCount2,
                                                                           false, message2));
        assertSchemaMatch(component);
    ...
    /**
     * @return a test TableDataModel - sorting enabled on column 1.
     */
