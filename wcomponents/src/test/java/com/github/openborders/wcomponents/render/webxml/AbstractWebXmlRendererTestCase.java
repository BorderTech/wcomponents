...
import com.github.openborders.wcomponents.WebComponent;
import com.github.openborders.wcomponents.layout.UIManager;
import com.github.openborders.wcomponents.servlet.WebXmlRenderContext;
import com.github.openborders.wcomponents.util.NullWriter;
import com.github.openborders.wcomponents.util.XMLUtil;
import com.github.openborders.wcomponents.util.mock.MockRequest;

/**
 * <p>This extension of junit TestCase includes assertions and 
 * other features useful for the testing WComponent XML layouts.</p>
 * 
 * <p>This differs from WComponentTestCase in that developers do
 * not need to specify the schema for each component; it is 
 * derived from the theme in use. </p>
 *
...
public abstract class AbstractWebXmlRendererTestCase extends AbstractWComponentTestCase
{
    ...
    /**
     * We need to register the "ui" prefix with XMLUnit so 
     * that we can use it in XPath expressions. 
     */
    @BeforeClass
    ...
    {
        XmlLayoutTestNamespaceContext context = (XmlLayoutTestNamespaceContext) XMLUnit.getXpathNamespaceContext();
        XMLUnit.setXpathNamespaceContext(context.backing);
    }
    
    /**
     * Return the path to the schema to test against.
     * This can be overridden if client applications wish to validate
    ...
    /**
     * Return the schema name space URI.
     * This can be overridden if client applications wish to validate
     * their own components.
     *  
    ...
    /**
     * Renders the <code>component</code> to xhtml and asserts that the <code>xpathExpression</code> evaluates to
    ...
    /**
     * Renders the <code>component</code> to xhtml and then asserts that the <code>xpathExpression</code> exists in
     * that xhtml.
     */
    ...
    /**
     * Renders the <code>component</code> to xhtml and then asserts that the <code>xpathExpression</code> does not
     * exist in that xhtml.
     */
     ...
     *  
     * This is called by many of the other methods where a UIContext 
     * is not explicitly passed. Subclasses can therefore e.g.
     * override this to ensure that the same context is always used.
     * 
    ...
    /**
     * A namespace context which can resolve the html and ui namespaces 
     * without requiring network access. This is necessary when running
     * tests behing a firewall. 
     */
    private static final class XmlLayoutTestNamespaceContext implements NamespaceContext
    {
        ...
        {
            Set<String> prefixes = new HashSet<String>(2);
            prefixes.add("ui");
            prefixes.add("html");
    ...
    /**
     * <p>Asserts that any unsafe content has been escaped correctly.
     * Checks whether the XML is syntactically valid, matches the component
     * schema and doesn't contain any content returned by 
     * {@link #getMaliciousAttribute()}, {@link #getMaliciousAttribute(String)} or
     * {@link #getMaliciousContent()}.</p>
     * 
     * <p>Note: This method assumes that no components are emitting script tags
     * themselves.</p>
     * 
