package com.github.openborders.wcomponents.testapp; 
...
import com.github.openborders.wcomponents.TestLookupTable;
...
/** 
 * This class is the top most wcomponent that represents a test application
 * that we can use to study the performance of wcomponents.
 * It is a simple application that collects some search criteria, displays
 * a list of results, and displays details for one of those results.
 * 
...
public class TestApp extends WApplication
{
    ...
    public void doSearch()
    {
        ...
        List<SearchResultRowBO> results = new ArrayList<SearchResultRowBO>(numRows);
