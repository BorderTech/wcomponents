...
public class UicStatsAsHtml_Test extends AbstractWComponentTestCase
{
    ...
    public void testWriter()
    {
        ...
        String uicStatsHtml31 = UICSTATS_HTML3.replaceAll("<<CLASS_NAME>>", "com.github.openborders.wcomponents.WApplication");
        String uicStatsHtml32 = UICSTATS_HTML3.replaceAll("<<CLASS_NAME>>", "com.github.openborders.wcomponents.WButton");
        String uicStatsHtml33 = UICSTATS_HTML3.replaceAll("<<CLASS_NAME>>", "com.github.openborders.wcomponents.WLabel");
