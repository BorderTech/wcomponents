...
public class VelocityInterceptor_Test extends AbstractWComponentTestCase
{
    ...
    public void testPaint()
    {
        ...
        component.setTemplate("com/github/openborders/wcomponents/container/VelocityComponent_Test1.vm");
        ...
        component.setTemplate("com/github/openborders/wcomponents/container/VelocityComponent_Test2.vm");
        ...
        component.setTemplate("com/github/openborders/wcomponents/container/VelocityComponent_Test3.vm");
        stringWriter.getBuffer().setLength(0);
        component.paint(renderContext);
        renderedFormat = stringWriter.toString().trim();
        Assert.assertEquals("Incorrect rendered format", "", renderedFormat);
