...
import com.github.openborders.wcomponents.MockLabel;
import com.github.openborders.wcomponents.RenderContext;
import com.github.openborders.wcomponents.WContainer;
import com.github.openborders.wcomponents.render.nil.NullRenderContext;
...
public class ValidateXMLInterceptor_Test extends AbstractWComponentTestCase
{
    ...
    public static void setUp()
    {
        ...
        overrides.setProperty("wcomponent.debug.enabled", "true");
        overrides.setProperty("wcomponent.debug.validateXML.enabled", "true");
