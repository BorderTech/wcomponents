...
import com.github.openborders.container.VelocityInterceptor;
...
public class VelocityInterceptor_Test extends AbstractWComponentTestCase
{
    ...
    public void testPaint()
    {
        ...
        component.setTemplate("com/github/openborders/container/VelocityComponent_Test1.vm");        
        ...
        component.setTemplate("com/github/openborders/container/VelocityComponent_Test2.vm");        
        ...
        component.setTemplate("com/github/openborders/container/VelocityComponent_Test3.vm");        
        stringWriter.getBuffer().setLength(0);
        component.paint(renderContext);
        renderedFormat = stringWriter.toString().trim();        
        Assert.assertEquals("Incorrect rendered format", "", renderedFormat);
    ...
    /** 
     * A test object containing a "bad method" that throws an exception.
     * This class needs to be public so that the methods can be used from a Velocity template.
     * @author Yiannis Paschalidis 
     */
