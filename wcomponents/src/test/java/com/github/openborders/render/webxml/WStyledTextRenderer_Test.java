...
import com.github.openborders.render.webxml.WStyledTextRenderer;
...
public class WStyledTextRenderer_Test extends AbstractWebXmlRendererTestCase
{
    ...
    public void testPaint() throws IOException, SAXException, XpathException
    {
     ...
     /**
      * This function tests the rendered content of the ui:text.
      * This is necessary, as there doesn't seem to be a nice way 
      * to obtain the nested content using XPath.
      *  
