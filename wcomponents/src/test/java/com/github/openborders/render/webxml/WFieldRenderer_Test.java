...
import com.github.openborders.render.webxml.WFieldRenderer;
...
public class WFieldRenderer_Test extends AbstractWebXmlRendererTestCase
{
    ...
    {
        WField field = new com.github.openborders.WFieldLayout().addField("test1", new WTextArea());
    ...
    public void testDoPaintBasic() throws IOException, SAXException, XpathException
    {
        ...
        com.github.openborders.WFieldLayout test = new com.github.openborders.WFieldLayout();
