...
public class I18nUtilities_Test
{
    ...
    /**
     * Tests that the Utilities class returns the correct bundle base name.
     * The bundle base name is configured in wcomponent_test.properties.
     */
    @Test
    ...
    public void testFormatInternalMessage()
    {
        ...
        String result = I18nUtilities.format(PROVIDED_LOCALE, "wcomponent.message.printButton");
        ...
        try
        {
            ...
            result = I18nUtilities.format(PROVIDED_LOCALE, "wcomponent.message.printButton");
            Assert.assertEquals("Incorrect text", "Print", result);
        }
        finally
        {
