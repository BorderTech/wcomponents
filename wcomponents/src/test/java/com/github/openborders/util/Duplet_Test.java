...
public class Duplet_Test
{
    ...
    {
        Duplet<String, Integer> duplet = new Duplet<String, Integer>();
    ...
    {
        Duplet<String, Integer> duplet = new Duplet<String, Integer>("testConstructor.value1", 1);
    ...
    public void testEquals()
    {
        ...
        Assert.assertFalse("Duplet should not equal another class", dup1.equals(""));
