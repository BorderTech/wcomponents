...
public class WEmailField_Test extends AbstractWComponentTestCase
{
    ...
    {
        assertAccessorsCorrect(new WEmailField(), "suggestions", null, new WSuggestions(), new WSuggestions());
    }
    ...
    public void testValidate()
    {
        ...
        for (String address : invalidAddresses)
        {
            ...
            field.validate(diags);
            Assert.assertFalse("'" + address + "' passed as a valid email address but should be invalid", diags.isEmpty());
        }
        ...
        for (String address : validAddresses)
        {
            ...
            field.setText(address);
            field.validate(diags);
            Assert.assertTrue("'" + address + "' did not pass as a valid email address", diags.isEmpty());
        }
    }
    ...
    public void testSetInvalidEmailAddressErrorMessage()
    {
        ...
        Assert.assertEquals("Diagnostic should contain custom error message", msg, diags.get(0).getDescription());
    }
