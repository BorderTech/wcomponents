...
import com.github.dibp.wcomponents.render.webxml.VelocityRenderer;
...
public class VelocityRenderer_Test extends AbstractWComponentTestCase
{
    ...
    {
        String layoutUrl = "com/github/dibp/wcomponents/velocity/VelocityRenderer_Test.vm";
    ...
    public void testPaint()
    {
        ...
        VelocityRenderer layout = new VelocityRenderer("com/github/dibp/wcomponents/velocity/VelocityRenderer_Test.vm");
        ...
        Assert.assertTrue("Missing 'this'", result.contains("this=com.github.dibp.wcomponents.velocity.VelocityRenderer_Test$TestComponent"));
        Assert.assertTrue("Missing 'this.someProperty'", result.contains("[this.someProperty=somePropertyValue]"));
        Assert.assertTrue("Missing 'uicontext'", result.contains("[uicontext=com.github.dibp.wcomponents.UIContextImpl"));
        Assert.assertTrue("Missing 'uic'", result.contains("uicontext=com.github.dibp.wcomponents.UIContextImpl"));
    ...
    {
        TestComponent component = new TestComponent();
        VelocityRenderer layout = new VelocityRenderer("/com/github/dibp/wcomponents/velocity/VelocityRenderer_Test_missing_template.vm");
