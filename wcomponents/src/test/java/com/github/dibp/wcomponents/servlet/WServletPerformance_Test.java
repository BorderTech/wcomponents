...
import com.github.dibp.wcomponents.servlet.WServlet.WServletHelper;
import com.github.dibp.wcomponents.util.mock.servlet.MockHttpServletRequest;
import com.github.dibp.wcomponents.util.mock.servlet.MockHttpServletResponse;
import com.github.dibp.wcomponents.util.mock.servlet.MockHttpSession;
import com.github.dibp.wcomponents.util.mock.servlet.MockServletConfig;

/**
 * Tests to check the performance of WComponent servlet processing.
 * This test does not check for correct behaviour - see
...
public class WServletPerformance_Test extends AbstractWComponentTestCase
{
    ...
    /**
     * Basic sanity-test to ensure that the WComponent app is
    ...
    /**
     * Basic sanity-test to ensure that the other app is
     * performing all the processing that it should.
     */
    @Test
