...
public class ObjectGraphDump_Test extends AbstractWComponentTestCase
{
    ...
    public void testDump()
    {
        ...
        Assert.assertTrue("", result.indexOf("type=\"com.github.dibp.wcomponents.WPanel\"") != -1);
        Assert.assertTrue("", result.indexOf("field=\"label\" type=\"com.github.dibp.wcomponents.WLabel\"") != -1);
        Assert.assertTrue("", result.indexOf("field=\"text\" value=\"&quot;" + TEST_LABEL
                                      + "&quot;\" type=\"java.io.Serializable\"") != -1);
        Assert.assertTrue("", result.indexOf("field=\"value\" type=\"com.github.dibp.wcomponents.layout.BorderLayout$BorderLayoutConstraint\"") != -1);
    }
}
