...
import com.github.dibp.wcomponents.servlet.ServletUtil;
...
import com.github.dibp.wcomponents.util.mock.servlet.MockHttpServletRequest;

/**
 * Tests to check the performance of WComponent graph serialization.
 * This test does not check for correct serialization - see
...
{
    /** 
     * The number of repetitions to use for testing serialization time.
     * This should be set to be greater than the minimum number of invocations
    ...
    /**
     * Invokes WComponent request processing, so that this test case 
     * can more closely match a production scenario.
     * 
    ...
    {
        List<WComponent> components = new ArrayList<WComponent>();
    ...
    /**
     * AllComponents instantiated with 10 repetitions.
     * This needs to be created as a subclass as the UIRegistry uses the class name.
     */
