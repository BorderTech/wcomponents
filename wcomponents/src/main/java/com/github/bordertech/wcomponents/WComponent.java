...
public interface WComponent extends WebComponent
{
     ...
     * If has id name set:
     * <ul>
     * <li>Find the closest ancestor to this component in the tree hierarchy that is an active {@link NamingContextable}.</li>
     * If no context found, then let the ID be the idname. </li>
    ...
    /**
     * Exposes the base URL from WEnvironment so that Renderers can construct appropriate URIs. Prior to this
     * modification the baseURL was assumed to be present in the HTML <base/>tag, this approach is not suitable for
     * portlet deployment.
     * 
     * @return the base URL for the application hosting this WComponent
     */
    String getBaseUrl();
