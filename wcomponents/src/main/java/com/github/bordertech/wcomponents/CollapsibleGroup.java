...
/**
 * <p>This class is used to group multiple {@link WCollapsible} components and one
 * {@link WCollapsibleToggle} component together. Each collapsible component in
 * the same group has the same name.</p>
 * 
 * <p>The <code>WCollapsibleToggle</code> component of the group applies to only
...
public class CollapsibleGroup implements Serializable
{
    ...
    private final List<WCollapsible> collapsibleList = new ArrayList<WCollapsible>();
