...
public class WCollapsibleToggle extends AbstractWComponent implements AjaxTarget
{
    ...
    /**
     * Retrieves the name of the {@link CollapsibleGroup} associated with this toggle.
     * If no group has been associated, this component's name is returned.
     * 
    ...
    /**
     * If not running client-side, it is WCollapsibleToggle's responsibility
     * to expand/collapse each individual WCollapsible in the group.
     *
     ...
     */
    private static final void setCollapsed(final WCollapsible collapsible, final boolean collapsed) 
    {
        List<WRepeater> repeaters = new ArrayList<WRepeater>();
     ...
     * @param collapsed true if the collapsible is to be collapsed, false if it is to be expanded.
     */
    private static final void setCollapsed(final List<WRepeater> repeaters, 
