...
public interface UIContext extends Serializable
{
     ...
     * The runnable will be invoked against this UIContext.
    ...
    /**
     * Returns the creation time of this UIContext, which can be used 
     * to approximate the user session creation time.
     * 
