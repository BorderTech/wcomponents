package com.github.openborders.util.thumbnail;
...
public class ThumbnailUtil
{
     ...
     */
    public static com.github.openborders.Image createThumbnail(final InputStream is, final String name,
                                                               final Dimension scaledSize, final String mimeType)
    {
        ...
        com.github.openborders.Image image = handleDefaultImage(mimeType, name, scale);
        return image;
    }
     ...
     */
    private static com.github.openborders.Image handleDefaultImage(final String mimeType, final String name,
                                                                   final Dimension scale)
    {
        com.github.openborders.Image image = null;
        if (mimeType == null)
        {
