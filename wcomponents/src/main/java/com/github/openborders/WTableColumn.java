...
/**
 * WTableColumn represents a column in a {@link WDataTable}. It only holds configuration
 * and state information relating to the UI, and does not know about the data model.
 * 
