...
/** 
 * <p>WCheckBoxSelect is a convenience class which presents a group of check boxes for 
 * the user to select one or more options from. Unlike {@link WCheckBox}, the check 
 * boxes inside a WCheckBoxSelect will automatically have text labels associated with 
 * them. The visual arrangement of the check boxes can be configured using the 
