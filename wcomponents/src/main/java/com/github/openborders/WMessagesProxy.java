...
/**
 * WMessagesProxy - A proxy used by {@link WMessages} when a component does not have 
 * an ancestor that implements MessageContainer when 
...
class WMessagesProxy extends WMessages
{
    ...
    /**
     * Utility method that searches for the WMessages instance for the given component.
     * If not found, a warning will be logged and null returned.
     * 
    ...
    /**
     * Provides a proxy for the WValidationErrors exposed by {@link WMessages#getValidationErrors()}. 
     * All methods in this proxy will delegate to the WValidationErrors instance 
     * for the given component, or will have no effect if there is no instance found.
     * 
     * @author Yiannis Paschalidis
     */
    private final class WValidationErrorsProxy extends WValidationErrors
    {
        ...
        public List<Diagnostic> getErrors()
        {
            ...
            return new ArrayList<Diagnostic>(0);
        }
        ...
        public List<GroupedDiagnositcs> getGroupedErrors()
        {
            ...
            return new ArrayList<GroupedDiagnositcs>(0);
        }
