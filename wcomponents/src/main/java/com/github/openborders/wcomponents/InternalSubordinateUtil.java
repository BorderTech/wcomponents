...
import com.github.openborders.wcomponents.subordinate.AbstractSetVisible;

/** 
 * <p>This class is a work-around to having the subordinate 
 * classes declared in a different package. It must not be
 * used by application code.</p>
 * 
 * <p>TODO: When the package hierarchy is renamed, the subordinate classes should be moved to the main package and this class deleted.</p>
 * 
...
public final class InternalSubordinateUtil
{
     ...
     */
    public static void applyAction(final AbstractSetVisible action, final SubordinateTarget target, final Object value)
    {
