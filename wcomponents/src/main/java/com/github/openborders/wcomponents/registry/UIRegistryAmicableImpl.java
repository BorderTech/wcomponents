package com.github.openborders.wcomponents.registry;
...
import com.github.openborders.wcomponents.ErrorPage;
import com.github.openborders.wcomponents.FatalErrorPageFactory;
import com.github.openborders.wcomponents.WComponent;
import com.github.openborders.wcomponents.container.AbstractContainerHelper;
...
/**
 * <p>This UIRegistry implementation differs from the UIRegistryClassLoaderImpl in two ways.</p>
 * 
 * <p>1. If the top level WComponent cannot be loaded, then an ErrorPage WComponent will
 * be returned by {@link #getUI(String)} instead of a null. The ErrorPage will be 
 * generated using the {@link FatalErrorPageFactory}.</p>
 * 
 * <p>2. The ErrorPage WComponent will not be cached so that subsequent calls to 
...
public class UIRegistryAmicableImpl extends UIRegistry
{
    ...
    /** The UI registry map. */
    private final Map<String, WComponent> registry = new HashMap<String, WComponent>();
     ...
     * If the UI has not been registered, this attempts to load the UI 
     * using the key as a class name.
     * 
     * @param key The registration key.
     ...
     * 
     * @param key The registration key.
     * @return A WComponent if one could be loaded from the classpath, 
     *     else an ErrorPage WComponent containing the problem.
     */
