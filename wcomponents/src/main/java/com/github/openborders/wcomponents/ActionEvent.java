...
public class ActionEvent extends EventObject
{
     ...
     * @param command a string that may specify a command associated with the event. (Normally the "actionCommand" from the source WButton)
     */
     ...
     * @param source the object that originated the event. (Normally a WButton)
     * @param command a string that may specify a command associated with the event. (Normally the "actionCommand" from the source WButton)
     * @param actionObject a data object that may contain information related to the event. (Normally the "actionObject" from the source WButton)
     */
