...
import com.github.openborders.wcomponents.Headers;
...
/**
 * <p>A default implementation of the PageShell interface.</p>
 * 
 * <p>This implementation writes the absolute minimum amount of mark-up necessary
...
public class DefaultPageShell implements PageShell
{
    ...
    /**
     * Retrieves the application title for the given context.
     * This mess is required due to WWindow essentially existing as a separate UI root.
     * If WWindow is eventually removed, then we can just retrieve the title from
