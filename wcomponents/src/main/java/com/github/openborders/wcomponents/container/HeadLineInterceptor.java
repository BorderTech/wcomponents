...
/**
 * Adds headline entries to a page. Headline entries are intended to only be
 * added once to a page, but in a portal environment this proves difficult.
 * This interceptor is currently used on a per-portlet basis which is not
 * really what we want. It seems to work for now.
 * 
...
public class HeadLineInterceptor extends InterceptorComponent
{
     ...
     * Any old headers are cleared out before preparePaint is called on the main UI.
     * 
     ...
     * This implementation is responsible for rendering the headlines for the UI.
     * 
