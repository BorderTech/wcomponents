package com.github.openborders.wcomponents.validation; 
 ...
 * validation has passed is to be provided in the <code>executeOnValid()</code> method.
 * </p>
 * 
 * @author Adam Millard 
 */
public abstract class ValidatingAction implements Action
{
     ...
     * Note that any visible components within the componentToValidate will also be validated.
     * 
    ...
    /**
     * Sets the component to validate. Note that any visible components 
     * within the component will also be validated.
     *  
     * @param componentToValidate the component to be validated for this action.
     */
    ...
    /**
     * This method can be overridden to perform additional validations, but don't
     * forget to call super.validate if you still want to perform default validation.
     * 
    ...
    /**
     * <p>This method is called if errors are found from validation.</p>
     * 
     * <p>This method can be overriden, but don't forget to call super.executeOnError
     * if you still want to see error messages.</p> 
     *  
     * @param event the action event which triggered this action.
