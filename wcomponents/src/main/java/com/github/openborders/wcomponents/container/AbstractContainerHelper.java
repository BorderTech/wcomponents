...
import com.github.openborders.wcomponents.ActionEscape;
import com.github.openborders.wcomponents.Environment;
import com.github.openborders.wcomponents.Escape;
import com.github.openborders.wcomponents.FatalErrorPageFactory;
import com.github.openborders.wcomponents.Request;
import com.github.openborders.wcomponents.Response;
...
import com.github.openborders.wcomponents.util.Factory;
import com.github.openborders.wcomponents.util.SerializationUtil;
...
public abstract class AbstractContainerHelper
{
    ...
    private static final String DEVELOPER_MODE_CLUSTER_EMULATION = "wcomponent.developer.clusterEmulation.enabled";
    ...
    public static final String TERMINATE_SESSION_ON_ERROR = "wcomponent.terminateSessionOnError";
    ...
    public void processAction() throws IOException
    {
        ...
        try
        {
            ...
            getInterceptor().serviceRequest(request);
     ...
     * parameter <code>wcomponent.logout.url</code>. Note that this method is called after {@link #invalidateSession()},
     * so there may not be any session information available.
     */
    ...
    {
        Request request = getRequest();
        return request != null && request.getAppSessionAttribute(ACTION_ERROR_KEY) != null;
    }
    ...
    private Throwable getPropogatedError()
    {
        ...
        if (request != null)
        {
            return (Throwable) request.getAppSessionAttribute(ACTION_ERROR_KEY);
        }
    ...
    private void clearPropogatedError()
    {
        ...
        if (request.getAppSessionAttribute(ACTION_ERROR_KEY) != null)
        {
            log.debug("Clearing error remembered from previous action phase");
            request.setAppSessionAttribute(ACTION_ERROR_KEY, null);
        }
    }
