        ...
        if (options != null)
        {
            ...
            for (Object option : options)
            {
                if (option instanceof OptionGroup)
                {
                    ...
                    {
                        renderOption(dropdown, nestedOption, optionIndex++, xml, selectedOption, renderSelectionsOnly, encode);
                    }                
                ...
                {
                    renderOption(dropdown, option, optionIndex++, xml, selectedOption, renderSelectionsOnly, encode);
                }
            }
        }
