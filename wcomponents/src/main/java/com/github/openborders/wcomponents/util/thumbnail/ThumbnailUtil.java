...
public class ThumbnailUtil
{
     ...
     */
    public static com.github.openborders.wcomponents.Image createThumbnail(final InputStream is, final String name,
                                                               final Dimension scaledSize, final String mimeType)
    {
        ...
        com.github.openborders.wcomponents.Image image = handleDefaultImage(mimeType, name, scale);
        return image;
    }
     ...
     */
    private static com.github.openborders.wcomponents.Image handleDefaultImage(final String mimeType, final String name,
                                                                   final Dimension scale)
    {
        com.github.openborders.wcomponents.Image image = null;
        if (mimeType == null)
        {
