...
import com.github.openborders.wcomponents.util.LookupTableHelper;
...
public abstract class AbstractWSelectList extends AbstractInput
{
    ...
    public static final String DATALIST_CACHING_PARAM_KEY = "wcomponent.dataListCaching.enabled";
    ...
    /**
     * Sets the AJAX target for the list. If a target is supplied, as an AJAX request is made rather than a
