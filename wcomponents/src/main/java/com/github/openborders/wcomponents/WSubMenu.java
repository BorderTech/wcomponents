...
import com.github.openborders.wcomponents.WMenu.SelectMode;

/**
 * <p>This component is used to provide either a dropmenu (when added directly to
 * a {@link WMenu} or nestable sub menus (when added to another
 * <code>WSubMenu</code> instance).</p>
 *
 * <p>Sub Menus may contain the following components:
 * <ul>
 ...
 * </ul></p>
 *
 * <p>Actions on sub-menus are only supported for {@link WMenu.MenuType#COLUMN} menus.</p>
 *
 * @author Adam Millard
...
public class WSubMenu extends AbstractNamingContextContainer implements Disableable
{
    ...
    public static enum MenuMode
    {
         ...
         * @deprecated Use MenuMode DYNAMIC instead as a like-for-like replacement
     ...
     *
     * @param accesskey
     *            The key (in combination with the Alt key) that activates this element.
     */
    ...
    /**
     * Returns the accesskey character as a String. If the character is not a letter or digit then <code>null</code>
     * is returned.
     *
     ...
     * Note that actions are currently only supported for {@link WMenu.MenuType#COLUMN} menus.
     *
     ...
     * This implementation checks for submenu selection and executes the associated action if it has been set.
     *
    ...
    /**
     * Override preparePaintComponent in order to correct the visibility of
     * the sub-menu's children before they are rendered.
     *
     * @param request the request being responded to.
     */
    @Override
    protected void preparePaintComponent(final Request request)
    {
        ...
        List<WComponent> children = new ArrayList<WComponent>(getChildCount());
