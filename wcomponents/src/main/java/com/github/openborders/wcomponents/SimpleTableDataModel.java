 ...
 * Note that use of this data model is discouraged, as the table data will
 * be stored in the user's session.
 * 
 * @author Yiannis Paschalidis 
 * @since 1.0.0
 * 
 * @deprecated Use {@link WTable} and {@link SimpleTableModel} instead.
 */
@Deprecated
public class SimpleTableDataModel extends AbstractTableDataModel
{
     ...
     */
    public SimpleTableDataModel(final List<? extends List<? extends Serializable>> data)
    {
     ...
     */
    public SimpleTableDataModel(final Serializable[][] data)
    {
        this.data = data;
    }
     ...
     * This model only supports editability at a global
     * level. See {@link #setEditable(boolean)}.
     * 
     * @param row ignored.
     * @param col ignored.
