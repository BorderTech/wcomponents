 ...
 * Current supported environments are Servlet and Portlet.
 * 
...
public interface Environment extends Serializable
{
     ...
     * image data and PDFs. It is also used to support AJAX regions.
     * Targeted requests are handled by the WContentHelperServlet.
     */
     ...
     */
    String SUPPORT_SERVLET_PATH = "wcomponent.servlet.support.path";
    
    /**
     * The parameter variable that contains the URL path to the web content
     * for the Theme.
     */
    String THEME_CONTENT_PATH = "wcomponent.theme.content.path";
    
    /**
     * The URL query string parameter variable name that is used to ensure that
     * the URL appears unique to the browser. This is used to prevent caching
     * of PDFs, TR5s etc by the client.
     */
    String UNIQUE_RANDOM_PARAM = "no-cache";
    
    /**
     * The key we use to store the primary contexts in the user's session. The AJAX 
     * and content helper servlets will use this key to retrieve the appropriate 
     * UIC and process the request. The map is keyed by application Id, and will
     * contain one entry per Portlet in the application. If the application does not
     * use portlets, the map will only contain the single UIContext for the main servlet.
     * @deprecated portal specific
     */
    @Deprecated
     ...
     * <dt>Portlet</dt><dd>/wps/myportal/!ut/p/c1/04_SB8K8xLLM9MSSzPy8xBz9CP0os3hnUx8TA68gIwMDIzcgtvQ1DzVwNjM0cDcAykeaxfv5G4W6mXgaGlqYuRoaGJl5mDj5hHkauLsYE6PbAAdwNCCgOxzkWvy2g-TxmO_nkZ-bql-QGxphkGWiCADEMGSl/dl2/d1/L0lDU0NTSUpKZ0EhIS9JTlJBQUlnb0FNek1xc0EhL1lCSkp3NDU0NTAtNUZ3ISEvN19DNUw0MEpSMjBHQU9FMDJKTkg0TjlBMjAyMi9Yc0FldTE!#7_C5L40JR20GAOE02JNH4N9A2022</dd>
     * </dl>
     * 
    ...
    /**
     * Gets the URL path for the WComponent support servlets, which handle serving content 
     * for Targetable WComponents, AJAX and data lists. There needs to be a servlet (WServlet) 
     * deployed to serve Targetable content. This method returns the URL to that servlet.
     * <dl>
     * Examples of what this method may return:
     * <dt>Servlet</dt><dd>/app</dd>
    ...
    /**
     * Gets the base URL under which web applications are hosted. This is for portals
     * where multiple applications/portlets are being hosted. This AppHostPath can be
     * used to create url links to applications that have been given fixed relative
     * names.
     * <dl>
     * Examples of what this method may return:
     * <dt>Servlet</dt><dd></dd>
