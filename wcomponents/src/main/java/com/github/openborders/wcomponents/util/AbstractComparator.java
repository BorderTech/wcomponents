...
{
    /**
     * Subclasses must implement this method to obtain a derived 
     * comparable to use for comparison. A trivial implementation
     * would be to return the object itself if it is already a 
     * {@link Comparable}.
     * 
