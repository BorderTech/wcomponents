...
import com.github.openborders.wcomponents.layout.LayoutManager;
...
public class WPanel extends WContainer implements AjaxTarget, SubordinateTarget, Marginable, DropZone
{
    ...
    /** {@inheritDoc} */
    @Override
    public void setMargin(final com.github.openborders.wcomponents.Margin margin)
    {
    ...
    /** {@inheritDoc} */
    @Override
    public com.github.openborders.wcomponents.Margin getMargin()
    {
    ...
    public static class PanelModel extends BeanAndProviderBoundComponentModel
    {
        ...
        private com.github.openborders.wcomponents.Margin margin;
