package com.github.openborders.wcomponents.validator;
...
/**
 * This class can be used to validate that a WDateField is "before" or "after"
 * a particular "pivot" date. If no pivot date is supplied then "today" is used
 * as the default.
 *
...
public class DateFieldPivotValidator extends AbstractFieldValidator
{
     ...
     * The default validation is that the field must be "before or equal to today".
     */
    ...
    /**
     * Creates a DateFieldPivotValidator.
     * As no "pivot" date is supplied, the operation will be relative to "today".
     * 
     * @param operator the operator which controls how the dates will be compared. Must be one
     *         of {@link #BEFORE}, {@link #BEFORE_OR_EQUAL}, {@link #EQUAL},
