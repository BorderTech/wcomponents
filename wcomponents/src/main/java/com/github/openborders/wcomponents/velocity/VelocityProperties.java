...
/**
 * Components which use the VelocityLayout may implement this
 * interface, in which case the Map given in the getVelocityMap function
 * will be installed into the VelocityContext.
 *
...
public interface VelocityProperties
{
     ...
     * Implementations may clear the map at this point, since Velocity has done its thing.
     */
    void mapUsed();
}
