 ...
 * </p>
 * <p>
 * Use the {@link #getSelected() getSelected} method to determine which of the list of options
 * were chosen by the user. Note that getSelectedOptions will return a sub-set of the object instances supplied in the
