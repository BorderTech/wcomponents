...
public abstract class AbstractFieldValidator implements FieldValidator, Serializable
{
     ...
     * 
     * The format of the error message String must conform to the 
     * pattern required by <code>MessageFormat</code>.
     * 
     ...
     * @param input the input field to set.
     */
    public void setInputField(final Input input)
    {
        this.input = input;
    }
     ...
     * 
     * This is the format of the error message for a validator. It must 
     * conform to the pattern required by <code>MessageFormat</code>.
     * 
     * @see java.text.MessageFormat
     * 
     * @param errorMessage the error message.
    ...
    {
        List<Serializable> args = new ArrayList<Serializable>(1);
