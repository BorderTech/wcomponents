...
import com.github.openborders.wcomponents.WTable.ScrollableTableModel;

/** 
 * This extension of {@link TableDataModel} is primarily for models that do not
 * store their data locally. Models implementing this interface can provide
 * more efficient calls to back-end systems, as the data model is notified of 
...
{
    /**
     * This method will be called by the table to notify the TableDataModel
