...
/**
 * WFilterText is an extension of {@link WText} that can be used to replace text. 
 * Both the search and replace regular expressions must be set before text is filtered.
 * 
 * Example usage for a quick way to replace new lines with paragraphs (Note: Use 
 * {@link com.github.openborders.wcomponents.WStyledText} for this):
 * 
 * <pre>
