 ...
 * have an id. In the AJAX response the whole element is replaced by the response. Components which do not implement
 * the {@link AjaxTarget} interface can be wrapped in a {@link com.github.openborders.wcomponents.WPanel}.
 * </p>
 * 
...
public class WAjaxControl extends AbstractWComponent
{
    ...
    public WAjaxControl(final AjaxTrigger trigger, final AjaxTarget target)
    {
        ...
        List<AjaxTarget> targets = new ArrayList<AjaxTarget>();
        targets.add(target);
    ...
    public WAjaxControl(final AjaxTrigger trigger, final AjaxTarget[] targets)
    {
        ...
        List<AjaxTarget> targetList = new ArrayList<AjaxTarget>();
    ...
    {
        this(trigger);
        getComponentModel().targets = new ArrayList<AjaxTarget>(targets);
    }
    ...
    public void addTargets(final List<? extends AjaxTarget> targets)
    {
        if (targets != null)
        {
            ...
            {
                model.targets = new ArrayList<AjaxTarget>();
            }
     ...
     * An empty list is returned if no targets have been defined.
     * 
