...
import com.github.openborders.wcomponents.AbstractEnvironment;
...
import com.github.openborders.wcomponents.UserAgentInfo;
...
public class HttpServletHelper extends AbstractContainerHelper
{
    ...
    {
        String url = Config.getInstance().getString("wcomponent.logout.url", null);
    ...
    public static class HttpServletEnvironment extends AbstractEnvironment
    {
         ...
         */
        public HttpServletEnvironment(final String postPath, final String baseUrl, final String userAgent)
        {
         ...
         */
        public HttpServletEnvironment(final String postPath, final String baseUrl, final UserAgentInfo userAgentInfo)
        {
