...
import com.github.openborders.wcomponents.util.Enumerator;
import com.github.openborders.wcomponents.util.RequestUtil;
...
public abstract class AbstractRequest implements Request
{
    ...
    /**
     * @return the complete list of parameters contained in this request.
     * If the request contains no parameters, the method returns an empty <code>Map</code>.
     */
    ...
    /**
     * <p>{@link FileItem} classes (if attachements) will be kept as part of the request. The default behaviour of the file
     * item is to store the upload in memory until it reaches a certain size, after which the content is streamed to a
     * temp file.</p>
     *
     * <p>If, in the future, performance of uploads becomes a focus we can instead look into using the Jakarta
     * Commons Streaming API. In this case, the content of the upload isn't stored anywhere. It will be up to the user
     * to read/store the content of the stream.</p>
     *
