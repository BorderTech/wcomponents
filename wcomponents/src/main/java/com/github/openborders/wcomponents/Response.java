...
/**
 * An abstraction of a response to a client in a web environment,
 * that allows WComponents to function similarly when running 
 * in e.g. Servlet or Portlet environment.
 * 
