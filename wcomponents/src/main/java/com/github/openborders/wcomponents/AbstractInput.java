...
import com.github.openborders.wcomponents.util.EmptyIterator;
...
import com.github.openborders.wcomponents.validator.FieldValidator;
...
public abstract class AbstractInput extends WBeanComponent implements Input
{
    ...
    public void addValidator(final FieldValidator validator)
    {
        ...
        {
            model.validators = new ArrayList<FieldValidator>();
        }
    ...
    public Iterator<FieldValidator> getValidators()
    {
        ...
        return new EmptyIterator<FieldValidator>();
    }
     ...
     * </p>
     * <p>
     * This method will call {@link #doHandleRequest(Request)} for input components to process the request. If the
     * input component has changed, then this method will call {@link #doHandleChanged()} and set the 
