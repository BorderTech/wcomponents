...
/**
 * <p>
 * This component is used to render an error message box (commonly near the top of an application's UI) 
 * which contains all supplied validation errors.
 * </p>
 * <p>
 * This provides (in conjuntion with {@link WFieldErrorIndicator} components) the ability to link error messages
 * with the input field that is in error.
 * </p>
 * <p>
 ...
 * 
 * @see Diagnostic
 * @see com.github.openborders.wcomponents.WMessages
 *      
 * @author Adam Millard
 * @since 1.0.0
 */
public class WValidationErrors extends AbstractWComponent
{
    ...
    {
        List<GroupedDiagnositcs> grouped = new ArrayList<GroupedDiagnositcs>();
    ...
    public static class GroupedDiagnositcs
    {
        ...
        private final List<Diagnostic> diags = new ArrayList<Diagnostic>();
