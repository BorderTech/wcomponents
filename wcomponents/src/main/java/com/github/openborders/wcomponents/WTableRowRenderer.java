...
import com.github.openborders.wcomponents.WTable.RowIdWrapper;
...
public final class WTableRowRenderer extends WDataRenderer
{
    ...
    private static class RendererWrapper extends WBeanContainer implements BeanProvider
    {
         ...
         */
        public RendererWrapper(final WTableRowRenderer rowRenderer, final Class<? extends WComponent> rendererClass,
         ...
         * @param columnIndex the index of the column renderer, or -1 if the renderer is for expanded content.
         */
        public RendererWrapper(final WTableRowRenderer rowRenderer, final WComponent renderer, final int columnIndex)
        {
            this.rowRenderer = rowRenderer;
            this.columnIndex = columnIndex;
    ...
    /**
     * Adds a column to the renderer. This method is called by {@link WTable} to keep the renderer's and table's
     * columns in sync.
     * 
