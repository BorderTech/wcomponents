package com.github.openborders.wcomponents.util.mock.servlet; 
...
{
    /** 
     * The backing output stream to write content to, so that it may 
     * later be retrieved using {@link #getOutput}. 
     */
    private final ByteArrayOutputStream backing = new ByteArrayOutputStream();
    
    /**
     * Writes the specified byte to this output stream. The byte to 
     * be written is the eight low-order bits of the argument <code>b</code>. 
