...
/**
 * <p>WDecorated is a "decorated label" which is typically displayed inside other 
 * components, for example {@link com.github.openborders.wcomponents.WTab}. 
 * The decorated label allows deveopers to mix text with other content, e.g. images.</p>
 * 
