...
/** 
 * A simple tree based table data model which that takes in root node and an array 
 * of bean properties in its constructor. Note that use of this data model is discouraged, 
 * as the table data will be stored in the user's session.
 * 
