...
/** 
 * LookupTableHelper provides convenience methods to register lookup 
 * tables for use with the data list servlet.
 * 
...
{
    /**
     * The key we use to store the UIContext in the user's session. The data list 
     * servlet will use this key to retrieve the UIContext and process the request.
     */
    ...
    public static void registerList(final String key, final Request request)
    {
        ...
        request.setSessionAttribute(DATA_LIST_UIC_SESSION_KEY, UIContextDelegate.getPrimaryUIContext(uic));
    }
