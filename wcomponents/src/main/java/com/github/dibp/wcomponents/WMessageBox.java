 ...
 * {@link com.github.dibp.wcomponents.validation.WValidationErrors}.
 * </p>
 * 
 * @see com.github.dibp.wcomponents.validation.WValidationErrors
 * @see com.github.dibp.wcomponents.WMessages
 * @author Ming Gao
 * @author Adam Millard
...
public class WMessageBox extends AbstractWComponent implements AjaxTarget, SubordinateTarget
{
    ...
    public static class MessageModel extends ComponentModel
    {
        ...
        private final List<Duplet<Serializable, Boolean>> messages = new ArrayList<Duplet<Serializable, Boolean>>();
    }
    ...
    public void addMessage(final boolean encode, final String msg, final Serializable... args)
    {
        ...
        model.messages.add(new Duplet<Serializable, Boolean>(I18nUtilities.asMessage(msg, args), encode));
    }
    ...
    public List<String> getMessages()
    {
        ...
        List<String> messages = new ArrayList<String>(model.messages.size());
