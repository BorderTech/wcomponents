 ...
 * </p>
 *
 * <p><b>NOTE:</b> When setting the tab set type to be LEFT or RIGHT you should make use of the method
...
public class WTabSet extends AbstractNamingContextContainer implements Disableable, AjaxTarget, Marginable
{
    ...
    public static enum TabMode
    {
         ...
         * @deprecated Use TabMode DYNAMIC instead as a like-for-like replacement
    ...
    /**
     * Sets the content height of the tab set. This is primarily used for tab sets
     * where the tabs are positioned on the left or right, to limit the height of the tab set.
     *
     ...
     * Note that some tab sets support multiple active tabs, see {@link #getActiveIndices()}.
     * <p>
    ...
    public List<Integer> getActiveIndices()
    {
        ...
        if (activeTabs == null)
        {
            ...
            else
            {
                ...
                activeTabs = new ArrayList<Integer>(1);
                activeTabs.add(idx);
            }
        }
     ...
     * Note that some tab sets support multiple active tabs, see {@link #getActiveTabs()}.
     *
    ...
    public List<WTab> getActiveTabs()
    {
        ...
        List<WTab> activeTabs = new ArrayList<WTab>(activeIndices.size());
    ...
    public void setActiveIndices(final int[] indices)
    {
        ...
        {
            model.activeTabs = new ArrayList<Integer>(1);
        }
    ...
    {
        List<WTab> tabs = new ArrayList<WTab>(getChildCount());
    ...
    public void handleRequest(final Request request)
    {
        ...
        if (indicesStr != null && indicesStr.length > 0)
        {
            ...
            List<Integer> changes = new ArrayList<Integer>(1);
    ...
    /**
     * Sets whether only the "head" portion of a tab's
     * decorated label should be visible. At present, this
     * only has a visible effect on {@link TabSetType#APPLICATION} tab sets.
     *
    ...
    /**
     * Indicates whether only the "head" portion of a tab's
     * decorated label should be visible. At present, this
     * only has a visible effect on {@link TabSetType#APPLICATION} tab sets.
     *
