package com.github.dibp.wcomponents.util.thumbnail;
...
public class ThumbnailUtil
{
     ...
     */
    public static com.github.dibp.wcomponents.Image createThumbnail(final InputStream is, final String name,
                                                               final Dimension scaledSize, final String mimeType)
    {
        ...
        com.github.dibp.wcomponents.Image image = handleDefaultImage(mimeType, name, scale);
        return image;
    }
     ...
     */
    private static com.github.dibp.wcomponents.Image handleDefaultImage(final String mimeType, final String name,
                                                                   final Dimension scale)
    {
        com.github.dibp.wcomponents.Image image = null;
        if (mimeType == null)
        {
