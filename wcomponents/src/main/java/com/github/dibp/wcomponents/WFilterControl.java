...
/**
 * The WFilterControl lets the user filter data within another (table) component. 
 * The filtering occurs client-side, based on text matching.
 * 
...
public class WFilterControl extends AbstractContainer implements AjaxTarget
{
     ...
     */
    public WFilterControl(final WDecoratedLabel filterLabel, final WComponent target, final String value)
    {
        this(filterLabel);
