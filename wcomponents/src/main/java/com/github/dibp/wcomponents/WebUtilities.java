...
public final class WebUtilities
{
    ...
    private static final String PROJECT_VERSION_PARAMETER_KEY = "wcomponent.version";
    ...
    public static String getContentType(final String fileName)
    {
        ...
        String mimeType = config.getString("wcomponent.mimeType." + suffix);

        if (mimeType == null)
        {
            mimeType = config.getString("wcomponent.mimeType.defaultMimeType", "application/octet-stream");
        }
