...
import com.github.dibp.wcomponents.util.Duplet;

/** 
 * <p>WDefinitionList is used to render pair lists of terms/data.</p>
 * 
...
public class WDefinitionList extends AbstractNamingContextContainer implements AjaxTarget, SubordinateTarget, Marginable
{
    ...
    /** 
     * Content is added to this hidden container, so nothing can be 
     * added to the definition list directly. 
     */
    ...
    /**
     * Adds a term to this definition list. If there is an existing term, 
     * the component is added to the list of data for the term.
     * 
    ...
    {
        Map<String, Duplet<String, List<WComponent>>> componentsByTerm = new HashMap<String, Duplet<String, List<WComponent>>>();
        List<Duplet<String, List<WComponent>>> result = new ArrayList<Duplet<String, List<WComponent>>>();
    ...
    {
        List<WComponent> childList = content.getComponentModel().getChildren();
        List<WComponent> result = new ArrayList<WComponent>();
