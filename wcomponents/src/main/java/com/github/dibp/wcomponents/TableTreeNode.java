...
/** 
 * <p>An extension of AbstractTreeNode that supports a data
 * attribute, the concept of being expanded/collapsed and
...
public class TableTreeNode extends AbstractTreeNode
{
    ...
    /**
     * Creates a TableTreeNode with the specified data.
     * The data may be an id or complex data, and should
     * be used in the {@link AbstractTreeTableDataModel#getValueAt(TableTreeNode, int)} method.
     * 
    ...
    /**
     * Adjusts the node count of this node and all parent nodes.
     * Called when nodes are being added/removed from the tree.
     * 
