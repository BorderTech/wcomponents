...
import com.github.dibp.wcomponents.validation.WFieldWarningIndicator;
import com.github.dibp.wcomponents.validator.FieldValidator;
...
public class WField extends AbstractContainer implements AjaxTarget, SubordinateTarget
{
     ...
     * 
     * @param labelText
     *            contains the textual label to be displayed next to the input field.
     * @param field
     *            is the component to be layed out (normally in the right hand column). In order to support validation,
     *            the given field must be a WInput or a component that contains one WInput as a descendant.
     */
