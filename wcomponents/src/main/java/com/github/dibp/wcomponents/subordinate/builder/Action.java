...
public final class Action
{
    ...
    private final com.github.dibp.wcomponents.subordinate.Action.ActionType type;
     ...
     */
    public Action(final com.github.dibp.wcomponents.subordinate.Action.ActionType type, final SubordinateTarget target)
    {
                  ...
                  final WComponentGroup<? extends SubordinateTarget> group)
    {
        ...
        if (group == null
            && (com.github.dibp.wcomponents.subordinate.Action.ActionType.HIDEIN.equals(type)
                || com.github.dibp.wcomponents.subordinate.Action.ActionType.SHOWIN.equals(type)
                || com.github.dibp.wcomponents.subordinate.Action.ActionType.ENABLEIN.equals(type) || com.github.dibp.wcomponents.subordinate.Action.ActionType.DISABLEIN
                    .equals(type)))
        {
     ...
     */
    public com.github.dibp.wcomponents.subordinate.Action.ActionType getType()
    {
        return type;
    }
     ...
     */
    public com.github.dibp.wcomponents.subordinate.Action build()
    {
        switch (type)
        {
            case DISABLE:
