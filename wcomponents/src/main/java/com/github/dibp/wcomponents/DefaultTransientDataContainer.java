...
/** 
 * A default implementation of {@link AbstractTransientDataContainer}
 * that doesn't provide any data.
 * 
...
public class DefaultTransientDataContainer extends AbstractTransientDataContainer
{
    ...
    /**
     * Convenience method to creates a DefaultTransientDataContainer 
