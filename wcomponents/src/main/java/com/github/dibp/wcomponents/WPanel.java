...
import com.github.dibp.wcomponents.layout.LayoutManager;
...
public class WPanel extends WContainer implements AjaxTarget, SubordinateTarget, Marginable, DropZone
{
    ...
    /** {@inheritDoc} */
    @Override
    public void setMargin(final com.github.dibp.wcomponents.Margin margin)
    {
    ...
    /** {@inheritDoc} */
    @Override
    public com.github.dibp.wcomponents.Margin getMargin()
    {
    ...
    /**
     * <p>Adds the given component as a child of this component. The constraints
    ...
    public void add(final WComponent component, final Serializable... constraints)
    {
        ...
        if (constraints != null && constraints.length > 0)
        {
            ...
            {
                model.layoutConstraints = new HashMap<WComponent, Serializable>();
            }
    ...
    void remove(final WComponent aChild, final boolean tidyTheSession)
    {
        ...
        if (model.layoutConstraints == null)
        {
            ...
            {
                model.layoutConstraints = new HashMap<WComponent, Serializable>(defaultConstraints);
            }
        }
    ...
    public static class PanelModel extends BeanAndProviderBoundComponentModel
    {
        ...
        private com.github.dibp.wcomponents.Margin margin;
