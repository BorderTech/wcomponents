...
/**
 * <p>The WLabel component is used to display a textual label for an input field. A 
 * WLabel is associated with an input field provided in the labels constructor, or 
 * via the {@link #setForComponent(WComponent) setForComponent} method.</p>
 * 
...
public class WLabel extends AbstractMutableContainer implements AjaxTarget
{
     ...
     *            The label text.
     * @param accessKey
     *            The access key for the label's <code>forComponent</code>.
     */
    ...
    /**
     * Sets the label "hint" text, which can be used
     ...
     * 
     * @param accesskey
     *            The key (in combination with the Alt key) that activates this label.
     * @since 1.0.0
     */
    ...
    /** 
     * <p>Sets whether the heading text needs to be encoded.</p>
     * 
    ...
    /**
     * Sets the client visibility of this label. This method should only 
     * ever be called to hide labels which are intended for use by 
     * screen-readers.
     * 
