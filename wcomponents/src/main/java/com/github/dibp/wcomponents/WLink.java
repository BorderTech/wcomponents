 ...
 * WLink wLink = new WLink.Builder("WLink using builder and with attrs", "http://dibp.github.io/").
...
public class WLink extends WBeanComponent implements Container, Disableable, AjaxTarget, SubordinateTarget
{
     ...
     * @see <a href="http://www.w3.org/TR/html4/struct/links.html#adef-rel">Links in html docuemnts</a>
     */
     ...
     */
    private final static class LinkImage extends WImage
    {
         ...
         */
        public LinkImage(final WLink link)
        {
            this.link = link;
        }
