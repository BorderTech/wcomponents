...
public final class XmlStringBuilder extends PrintWriter
{
     ...
     * 
     * @param name
     *            the name of the ending tag to be added.
     */
     ...
     * All attribute values are escaped to prevent malformed XML and XSS attacks.
     * </p>
     * <p>
     ...
     * 
     * @param name
     *            the name of the boolean attribute to be added.
     * @param flag
     *            should this attribute be set.
     * @param value
     *            the value of the attribute.
     */
     ...
     *            the String to append.
     * @param encode
     *            true to encode the string before output, false to output as is
     */
     ...
     * If the string is null then no text will be appended.
     * 
    ...
    /**
     * Translates the given message into the appropriate user text.
     * This takes the current locale into consideration, if set.
     * 
