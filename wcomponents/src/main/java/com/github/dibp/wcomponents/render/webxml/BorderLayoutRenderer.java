...
import com.github.dibp.wcomponents.layout.BorderLayout.BorderLayoutConstraint;
...
final class BorderLayoutRenderer extends AbstractWebXmlRenderer
{
    ...
    public void doRender(final WComponent component, final WebXmlRenderContext renderContext)
    {
        ...
        List<Duplet<WComponent, BorderLayoutConstraint>> children = new ArrayList<Duplet<WComponent, BorderLayoutConstraint>>(childCount);

        for (int i = 0; i < childCount; i++)
        {
            WComponent child = panel.getChildAt(i);
            children.add(new Duplet<WComponent, BorderLayoutConstraint>(child, getConstraints(panel, child)));
        }
    ...
    /**
     * Retrieves the name of the element that will contain components
    ...
    /**
     * Retrieves the layout constraint for the given component. If the constraint
     * is incorrectly configured, an {@link IllegalStateException} will be thrown.
     * 
