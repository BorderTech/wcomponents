...
public final class ObjectGraphDump 
{
    ...
    private final Map<Class<?>, Field[]> instanceFieldsByClass = new HashMap<Class<?>, Field[]>();
    /** Objects that have been visited so far, to stop infinite recursion. */
    private final Map<Object, ObjectGraphNode> visitedNodes = new IdentityHashMap<Object, ObjectGraphNode>();
    ...
    /**
     * Adjusts the overhead of the given node, for types where not all 
     * data is output (e.g. Lists and Maps).
     * 
