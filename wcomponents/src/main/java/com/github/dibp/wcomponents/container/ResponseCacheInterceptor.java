...
public class ResponseCacheInterceptor extends InterceptorComponent
{
    ...
    public static enum CacheType
    {
        ...
        NO_CACHE("wcomponent.response.header.page.nocache", false),
        /** Theme cache */
        THEME_CACHE("wcomponent.response.header.theme.cache", true),
        /** Datalist no cache */
        DATALIST_CACHE("wcomponent.response.header.datalist.cache", true),
        /** Content cache */
        CONTENT_CACHE("wcomponent.response.header.content.cache", true),
        /** Content no cache */
        CONTENT_NO_CACHE("wcomponent.response.header.content.nocache", false);
        ...
        private String getDefaultSettings()
        {
            if (isCache())
            {
                return Config.getInstance().getString("wcomponent.response.header.default.cache",
                                                      DEFAULT_CACHE_SETTINGS);
            }
            else
            {
                return Config.getInstance().getString("wcomponent.response.header.default.nocache",
