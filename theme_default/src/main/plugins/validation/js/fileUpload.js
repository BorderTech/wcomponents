 ...
 *
 * @module ${validation.core.path.name}/fileUpload
...
define(["wc/dom/attribute",
	...
	/** @param attribute wc/dom/attribute @param event wc/dom/event @param initialise wc/dom/initialise @param i18n wc/i18n/i18n @param getFirstLabelForElement wc/ui/getFirstLabelForElement @param Widget wc/dom/Widget @param isComplete ${validation.core.path.name}/isComplete @param validationManager ${validation.core.path.name}/validationManager @param required ${validation.core.path.name}/required @param multiFileUploader wc/ui/multiFileUploader @ignore */
	function(attribute, event, initialise, i18n, getFirstLabelForElement, Widget, isComplete, validationManager, required, multiFileUploader) {
		...
		/**
		 * @constructor
		 * @alias module:${validation.core.path.name}/fileUpload~ValidationFileUpload
		 * @private
		 */
		function ValidationFileUpload() {
			 ...
			 * @function module:${validation.core.path.name}/fileUpload.initialise
			 ...
			 * @function module:${validation.core.path.name}/fileUpload.postInit
			 */
		...
		var /** @alias module:${validation.core.path.name}/fileUpload */ instance = new ValidationFileUpload();
