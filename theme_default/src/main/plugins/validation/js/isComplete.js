 ...
 *
 * @module ${validation.core.path.name}/isComplete
...
define(["wc/Observer",
	...
	/** @param Observer wc/Observer @param toArray wc/array/toArray @param getFilteredGroup wc/dom/getFilteredGroup @param isSuccessfulElement wc/dom/isSuccessfulElement @param tag wc/dom/tag @param Widget wc/dom/Widget @param validationManager ${validation.core.path.name}/validationManager @ignore */
	function(Observer, toArray, getFilteredGroup, isSuccessfulElement, tag, Widget, validationManager) {
		"use strict";
		/**
		 * @constructor
		 * @alias module:${validation.core.path.name}/isComplete~IsComplete
		 * @private
		 */
		function IsComplete() {
			var observer,
			 ...
			 * @function module:${validation.core.path.name}/isComplete.subscribe
			 * @public
			 ...
			 *
			 * @function module:${validation.core.path.name}/isComplete.isCompleteHelper
			 ...
			 *
			 * @function module:${validation.core.path.name}/isComplete.isContainerComplete
			 ...
			 * @function module:${validation.core.path.name}/isComplete.isComplete
		...
		return /** @alias module:${validation.core.path.name}/isComplete */ new IsComplete();
	});
