 ...
 *
 * @module ${validation.core.path.name}/cancelUpdate
...
define(["wc/dom/event",
	...
	/** @param event wc/dom/event @param initialise wc/dom/initialise @param Widget wc/dom/Widget @param focus wc/dom/focus @param validationManager ${validation.core.path.name}/validationManager @ignore */
	function(event, initialise, Widget, focus, validationManager) {
		"use strict";
		/**
		 * @constructor
		 * @alias module:${validation.core.path.name}/cancelUpdate~ValidationCancelUpdateControl
		 * @private
		 */
		function ValidationCancelUpdateControl() {
			 ...
			 * handling it.
			 *
			 * @function  module:${validation.core.path.name}/cancelUpdate.initialise
		...
		var /** @alias module:${validation.core.path.name}/cancelUpdate */ instance = new ValidationCancelUpdateControl();
