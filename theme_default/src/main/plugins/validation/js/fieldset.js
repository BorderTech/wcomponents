 ...
 *
 * @module ${validation.core.path.name}/fieldset
...
define(["wc/i18n/i18n",
	...
	function(i18n, initialise, shed, Widget, getFirstLabelForElement, isComplete, validationManager, required) {
		...
		function ValidationFieldset() {
			 ...
			 *
			 * @function module:${validation.core.path.name}/fieldset.revalidateFieldset
			 ...
			 * Initialise callback.
			 *
			 * @function module:${validation.core.path.name}/fieldset.postInit
			 */
		...
		var /** @alias module:${validation.core.path.name}/fieldset */ instance = new ValidationFieldset();
