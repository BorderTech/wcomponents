...
public final class Action_Test
{
    ...
    public void testConstructor1()
    {
        ...
        Assert.assertEquals("Incorrect type returned", com.github.bordertech.wcomponents.subordinate.Action.ActionType.DISABLE,
                            action.getType());
    ...
    {
        new Action(com.github.bordertech.wcomponents.subordinate.Action.ActionType.SHOWIN, new MyTarget(), null);
    }
    
    @Test(expected = IllegalArgumentException.class)
    public void testConstructorWithNullGroupHideIn()
    {
        new Action(com.github.bordertech.wcomponents.subordinate.Action.ActionType.HIDEIN, new MyTarget(), null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testConstructorWithNullGroupEnableIn()
    {
        new Action(com.github.bordertech.wcomponents.subordinate.Action.ActionType.ENABLEIN, new MyTarget(), null);
    }
    
    @Test(expected = IllegalArgumentException.class)
    public void testConstructorWithNullGroupDisableIn()
    {
        new Action(com.github.bordertech.wcomponents.subordinate.Action.ActionType.DISABLEIN, new MyTarget(), null);
    }
    ...
    public void testToString()
    {
        ...
        action = new Action(com.github.bordertech.wcomponents.subordinate.Action.ActionType.SHOWIN, target,
        ...
        action = new Action(com.github.bordertech.wcomponents.subordinate.Action.ActionType.HIDEIN, target,
                            new WComponentGroup<SubordinateTarget>());
        Assert.assertEquals("Incorrect toString for hideIn action", "hide MyTarget in WComponentGroup([])",
                            action.toString());

        action = new Action(com.github.bordertech.wcomponents.subordinate.Action.ActionType.ENABLEIN, target,
                            new WComponentGroup<SubordinateTarget>());
        Assert.assertEquals("Incorrect toString for enableIn action", "enable MyTarget in WComponentGroup([])",
                            action.toString());
        
        action = new Action(com.github.bordertech.wcomponents.subordinate.Action.ActionType.DISABLEIN, target,
                            new WComponentGroup<SubordinateTarget>());
