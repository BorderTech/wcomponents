...
public class Util_Test
{
	...
	public void testEquals()
	{
		...
		Assert.assertTrue("Equal failed for equal objects", Util.equals(new Integer(1), new Integer(1)));
		...
		Assert.assertFalse("Two distinct Objects should not be equal", Util.equals(new Object(), new Object()));		
	}
    ...
    public void testCompareAllowNull()
    {
        ...
        Assert.assertTrue("Nulls should be less than anything else", Util.compareAllowNull(null, "a") < 0);
        Assert.assertTrue("Anything should be greater than null", Util.compareAllowNull("a", null) > 0);
    ...
    public void testRightTrim()
    {
        ...
        Assert.assertEquals("Incorrect right trimmed value returned", " A", Util.rightTrim(" A  "));
        Assert.assertEquals("Incorrect right trimmed value returned", "  A", Util.rightTrim("  A  "));
        Assert.assertEquals("Incorrect right trimmed value returned", "A B C", Util.rightTrim("A B C"));
        Assert.assertEquals("Incorrect right trimmed value returned", "  A B C", Util.rightTrim("  A B C"));
        Assert.assertEquals("Incorrect right trimmed value returned", "  A B C", Util.rightTrim("  A B C "));
        Assert.assertEquals("Incorrect right trimmed value returned", "  A B C", Util.rightTrim("  A B C  "));
    }
    ...
    public void testLeftTrim()
    {
        ...
        Assert.assertEquals("Incorrect left trimmed value returned", "A  ", Util.leftTrim(" A  "));
        Assert.assertEquals("Incorrect left trimmed value returned", "A  ", Util.leftTrim("  A  "));
        Assert.assertEquals("Incorrect left trimmed value returned", "A B C", Util.leftTrim("A B C"));
        Assert.assertEquals("Incorrect left trimmed value returned", "A B C", Util.leftTrim("  A B C"));
        Assert.assertEquals("Incorrect left trimmed value returned", "A B C ", Util.leftTrim("  A B C "));
        Assert.assertEquals("Incorrect left trimmed value returned", "A B C  ", Util.leftTrim("  A B C  "));
    }
