...
public class ServletUtilDeviceType_Test {
	...
	private static final String MOBILE_SAFARI = "Mozilla/5.0 (iPad; CPU OS 9_3_3 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Version/9.0 Mobile/13G34 Safari/601.1";
	...
	public static Collection devices() {
		return Arrays.asList(new Object[][]{
			{DeviceType.TABLET, "Mobile Safari", MOBILE_SAFARI},
