 ...
 * Examples of condition functions include "equal", "and", "or", "not" etc.
 *
...
public interface Condition extends Serializable {
	 ...
	 * context.
	 *
	 * @return <code>true</code> if this condition evaluates to 'false',
	 * otherwise <code>false</code>.
	 */
	boolean isFalse();
	 ...
	 * by getting the values from the Request.
	 *
	...
	/**
	 * Indicates whether this condition evaluates to 'false' in the given
	 * context by testing the value in the Request.
	 *
	 * @param request the request being processed.
	 * @return <code>true</code> if this condition evaluates to 'false',
	 * otherwise <code>false</code>.
