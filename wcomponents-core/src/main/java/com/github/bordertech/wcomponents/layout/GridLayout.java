...
/**
 * GridLayout is a {@link LayoutManager} that emulates
...
public class GridLayout implements LayoutManager {
	...
	/**
	 * The number of rows, or 0 for a dynamic number of rows based on the number
	 * of components and columns.
	 */
	private final int rows;

	/**
	 * The number of columns, or 0 for a dynamic number of columns based on the
	 * number of components and columns.
	 */
	...
	/**
	 * @return the number of rows, or 0 for a dynamic number of rows based on
	 * the number of components and columns.
	 */
	public int getRows() {
		return rows;
	}
	...
	/**
	 * @return the number of columns, or 0 for a dynamic number of column based
	 * on the number of components and rows.
	 */
	public int getCols() {
		return cols;
	}
