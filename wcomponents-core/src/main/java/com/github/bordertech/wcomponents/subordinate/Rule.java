...
/**
 * A Rule defines the visibility control logic to be added to a
 * SubordinateControl. A Rule consists of a "condition" that will evaluate to
 * true or false, a list of actions to be executed if the condition is true, and
 * a list of actions to be executed if the condition is false.
 *
...
public class Rule implements Serializable {
	...
	/**
	 * Creates a Rule with the specified condition and no actions. Useful if you
	 * want to set the actions separately.
	 *
	...
	/**
	 * Creates a Rule with an onTrue and onFalse action. When execute() is
	 * called. If "condition" evaluates to true, "onTrue" is executed, else
	 * "onFalse" is executed. The "onTrue" and/or "onFalse" functions can be
	 * null.
	 *
	 * @param condition the condition to evaluate.
	 * @param onTrue the action to execute if the condition evaluates to true.
	...
	/**
	 * Add an action that should be executed if the condition evaluates to
	 * false.
	 *
	 * @param action the action to add.
	 */
