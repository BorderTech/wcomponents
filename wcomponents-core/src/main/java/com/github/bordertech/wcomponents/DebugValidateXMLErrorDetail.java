...
public class DebugValidateXMLErrorDetail
{
     ...
     * 
     * Two DebugValidateXMLErrorDetails are considered equal if they 
     * have the same error message and component description.
     * 
    ...
    public boolean equals(final Object obj)
    {
        ...
        return (other.errorMessage.equals(this.errorMessage) && other.componentDescription.equals(this.componentDescription));
    }
