...
public final class AjaxHelper
{
     ...
     * render phase.
     */
    private static final ThreadLocal<AjaxOperation> THREAD_LOCAL_OPERATION = new ThreadLocal<AjaxOperation>();

    /**
     * Holds the trigger component and its context.
     */
    private static final ThreadLocal<ComponentWithContext> THREAD_LOCAL_COMPONENT_WITH_CONTEXT = new ThreadLocal<ComponentWithContext>();
     ...
     * @return the AjaxOperation control configuration object.
     */
    public static AjaxOperation registerComponentTargetItself(final String triggerId, final Request request)
    {
    ...
    private static void registerAjaxOperation(final AjaxOperation operation, final Request request)
    {
        ...
        if (operations == null)
        {
            operations = new HashMap<String, AjaxOperation>();
