...
/**
 * This session token interceptor makes sure the content request being processed
 * is for the correct session.
 * <p>
 * Similar to {@link SessionTokenInterceptor} but caters for setting error codes
 * for content requests such as {@link WImage} when a token error is detected.
 * </p>
 *
