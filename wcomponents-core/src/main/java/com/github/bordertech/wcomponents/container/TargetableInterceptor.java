 ...
 * {@link Environment#TARGET_ID} exists on the request. If the parameter is
 * found then this interceptor replaces the top level ui component with the
 * {@link Targetable} component with the same id as the parameter value.
 *
