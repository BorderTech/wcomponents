...
public final class WDataTableRowRenderer extends WDataRenderer {
	 ...
	 * expanded row renderers have been correctly initialised.</p>
	 *
	 * <p>
	 ...
	 * here, and manually call its preparePaint.</p>
	 *
	...
	/**
	 * Adds a column to the renderer. This method is called by
	 * {@link WDataTable} to keep the renderer's and table's columns in sync.
	 *
