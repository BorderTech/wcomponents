 ...
 * <ol>
 *   <li> Source mode - by setting the <code>bordertech.wcomponents.velocity.fileTemplatesDir</code> parameter to
 ...
 *   <li> Classpath mode - by setting the <code>bordertech.wcomponents.velocity.fileTemplatesDir</code> parameter
...
public final class VelocityRenderer implements Renderer
{
    ...
    public void render(final WComponent component, final RenderContext context)
    {
        ...
        boolean debugLayout = Config.getInstance().getBoolean("bordertech.wcomponents.velocity.debugLayout", false);
