...
/**
 * <p>
 * A <code>FieldValidator</code> implementation used to match an input fields value with the
 * supplied regular expression. An error is added if the value does not match the supplied pattern.
 * </p>
 * <p>
