...
/**
 * <p>
 * A WPanel is used to group components together. It can optionally provide
 * additional styling for the group, for example to display a titled border.
 * Layouts can be used to arrange components within the panel.
 * </p>
 * <p>
 * Users can add a {@link WButton} ({@link #setDefaultSubmitButton(WButton)}) to
 * this component that will submit when the user hits the Enter key and the
 * cursor is in an input field inside the panel.
 * </p>
 *
...
public class WPanel extends WContainer implements AjaxTarget, SubordinateTarget, Marginable, DropZone {
	...
	public static enum Type {
		...
		PLAIN,
		/**
		 * An action panel is similar to CHROME but with a different appearance.
		 * It is intended to be used once per screen to highlight the main area
		 * of activity.
		 */
		ACTION,
		/**
	...
	public static enum PanelMode {
		...
		LAZY,
		/**
		 * An eager panel will load its content via AJAX immediately after the
		 * page is loaded.
		 */
		EAGER
	};
	...
	/**
	 * <p>
	 * Adds the given component as a child of this component. The constraints
	 * are made available to the {@link LayoutManager} if it requires them.</p>
	 *
	...
	/**
	 * Removes the given component from this component's list of children. This
	 * method has been overriden to remove any associated layout constraints.
	 *
	...
	/**
	 * Retrieves the layout constraints for the given component, if they have
	 * been set.
	 *
