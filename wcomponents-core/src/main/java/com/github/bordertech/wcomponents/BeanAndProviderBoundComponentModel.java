...
/**
 * The {@link ComponentModel} for components that support binding to a bean
 * either directly or through a BeanProvider. A direct binding has higher
 * precedence than an indirect binding.
 *
...
public class BeanAndProviderBoundComponentModel extends DataBoundComponentModel {
	...
	/**
	 * This bean property that the component is interested in. The property is
	...
	/**
	 * Sets the bean property that the component is interested in. The property
	 * is specified using Jakarta BeanUtils bean notation.
	 *
