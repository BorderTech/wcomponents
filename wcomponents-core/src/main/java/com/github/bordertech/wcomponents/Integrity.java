...
/**
 * <p>A convenience class to raise integrity issues. An integrity issue
 * is usually issued on misconfiguration of a WComponent.</p>
 *
 * <p>If the <code>sfp.web.integrity.terminate.mode</code> parameter is set,
 * an {@link IntegrityException} will be thrown, otherwise a warning
...
public final class Integrity
{
    ...
    public static void issue(final WComponent comp, final String message)
    {
        ...
        if (Config.getInstance().getBoolean("bordertech.wcomponents.integrity.terminate.mode", false))
        {
