 ...
 *
 * <p>
 * This extension of {@link ContentAccess} should be used to serve up large binary content (e.g.
 * video), rather than requiring the entire byte array to be held in memory.</p>
 *
