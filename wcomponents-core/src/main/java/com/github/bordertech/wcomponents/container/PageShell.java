...
/**
 * The PageShell interface describes the parts of a page which can be customised
 * by the end user.
 *
...
public interface PageShell {
	...
	/**
	 * Opens the document. This is the first bit of content written back to the
	 * client.
	 *
	...
	/**
	 * Writes the header information, which is written after all applications
	 * have rendered.
	 *
	 * @param writer the writer to write to.
	 */
	...
	/**
	 * Writes the footer information, which is written after all applications
	 * have rendered.
	 *
	 * @param writer the writer to write to.
	 */
	...
	/**
	 * Closes the document. This is the last bit of content written back to the
	 * client.
	 *
	 * @param writer the writer to write to.
	 */
