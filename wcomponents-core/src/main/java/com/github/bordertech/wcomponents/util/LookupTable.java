...
/**
 * The LookupTable interface describes a mechanism for providing WComponents with data sourced from
 * an application look-up table. Applications must implement this class and provide configure the
 * Factory by setting the following parameter in the application's {@link Config Configuration}:
 *
...
public interface LookupTable {
	...
	/**
	 * Retrieves the contents of a given table by a table identifier. This identifier can be any
	 * object appropriate to your application.
	 *
	...
	/**
	 * <p>
	 * Retrieves the cache id for the given table. This is used to enable caching of data sets,
	 * including on the client.</p>
	 *
	 * <p>
	 * If your data sets are session- or user-specific, your cache id must include this information
	 * so that the cache is invalidated.</p>
	 *
	 * <p>
	...
	/**
	 * Retrieves the description for a given table entry, or null if the type of object is not
	 * supported.
	 *
	 * @param table the source table.
	 * @param entry the table entry.
