 ...
 * </p>
 * <p>
 * When a user presses the button, it displays a confirmation prompt before
...
public class WConfirmationButton extends WButton {
	...
	/**
	 * Creates an empty confirmation button. An image or text must be provided
	 * separately.
	 */
	...
	/**
	 * Constructor. Set the button text and the accesskey. The accesskey in
	 * combination with the alt key will activate the button.
	 *
