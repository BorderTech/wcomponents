 ...
 *
 * <p>
 * See {@link com.github.bordertech.wcomponents.examples.WTextExample} for
 * example usage, including binding to bean data.</p>
 *
 * @author Adam Millard
 * @since 1.0.0
 *
 * @author Yiannis Paschalidis - rewritten as a bean aware component in
 * Sfp_Common10
 */
public class WText extends WBeanComponent {
	 ...
	 *
	 * <p>
	 * NOTE: If the text is dynamically generated, it may be preferable to
	 * override {@link #getText()} instead. This will reduce the amount of data
	 * which is stored in the user session.</p>
	 *
	 ...
	 *
	 * <p>
	 * <b>WARNING:</b> If you are using WText to display "user entered" or
	 * untrusted data, use of this method with <code>encodeText</code> set to
	 * <code>false</code> may result in security issues.</p>
	 *
	 * <p>
	 * <b>WARNING:</b> Avoid using WText to add excessive amounts of HTML
	 * mark-up to the UI. Embedded mark-up is more likely to break in future
	 * WComponent releases. If you are attempting to use WText for layout
	 * purposes, consider using a
	 * {@link com.github.bordertech.wcomponents.layout.LayoutManager LayoutManager}
	 * instead. For example, <code>new WText("&lt;br&gt;")</code> could be
	 * rewritten to use the
	 * {@link com.github.bordertech.wcomponents.layout.FlowLayout FlowLayout}
	 * layout with a vertical layout direction.</p>
	 *
