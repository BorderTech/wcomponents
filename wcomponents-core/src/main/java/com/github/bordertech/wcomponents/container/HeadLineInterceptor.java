 ...
 * added once to a page, but in a portal environment this proves difficult. This
 * interceptor is currently used on a per-portlet basis which is not really what
...
public class HeadLineInterceptor extends InterceptorComponent {
	 ...
	 * interceptor. Any old headers are cleared out before preparePaint is
	 * called on the main UI.
	 *
	 ...
	 * interceptor. This implementation is responsible for rendering the
	 * headlines for the UI.
	 *
