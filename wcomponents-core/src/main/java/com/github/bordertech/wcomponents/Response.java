...
/**
 * An abstraction of a response to a client in a web environment, that allows
 * WComponents to function similarly when running in e.g. Servlet or Portlet
 * environment.
 *
...
public interface Response {
	...
	/**
	 * @return an output stream which can return character or binary data to the
	 * client.
	 ...
	 * Normally, no further data will be written back to the client.
	 *
	 ...
	 *
	 * @param contentType a String specifying the MIME type of the content, e.g.
	 * text/html.
	 */
