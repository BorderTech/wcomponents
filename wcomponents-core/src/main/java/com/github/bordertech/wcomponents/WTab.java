...
/**
 * WTab encapsulates a tab on a tab set. The contents may or may 
 * not be rendered, depending on the tab mode. This class
 * is not intended to be instantiated outside {@link WTabSet}'s
 * addTab methods. 
 * 
...
public class WTab extends AbstractNamingContextContainer implements Disableable
{
     ...
     * the tab's content before it is rendered.
     * 
