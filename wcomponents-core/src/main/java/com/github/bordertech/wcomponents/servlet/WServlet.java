...
/**
 * This class enables hosting of wcomponents in a servlet container. To get a basic wcomponent
 ...
 * <li>Extend WServlet, overriding the getUI(Object) method to return your wcomponent
 * application.</li>
...
public class WServlet extends HttpServlet {
	...
	/**
	 * The name of the parameter that will specify the id of the element that triggered the AJAX
	 * request.
	 */
	...
	/**
	 * Service an HTTP request. The {@link #serviceInt(HttpServletRequest, HttpServletResponse)}
	 * method is called to do the actual servicing. If the serviceInt method throws an exception, it
	 * is caught and the user is shown a generic error page using the
	 * {@link #handleError(HttpServletRequest, HttpServletResponse, Throwable)} method.
	 *
	...
	/**
	 * Service internal. This method does the real work in servicing the http request. It integrates
	 * wcomponents into a servlet environment via a servlet specific helper class.
	 *
	...
	/**
	 * The interceptor component returned here is used to wrap the html fragment generated by the UI
	 * component.
	 *
	 ...
	 * <p>
	 * It is up to the subclass to determine the life cycle of the returned component. Should the
	 * same instance be returned and shared by all sessions, or should there be a new instance per
	 * session.
	 * <p>
	 ...
	 * top ui component's WHeaders object and adding headers to it.
	 *
