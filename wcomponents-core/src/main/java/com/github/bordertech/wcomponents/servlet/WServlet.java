...
/**
 * This class enables hosting of wcomponents in a servlet container. To get a
 * basic wcomponent application running in a servlet container:
 * <ul>
 * <li>Build your own wcomponent application from other building block
 * wcomponents.</li>
 * <li>Extend WServlet, overriding the getUI(Object) method to return your
 * wcomponent application.</li>
...
public class WServlet extends HttpServlet {
	...
	/**
	 * The name of the parameter that will specify the id of the element that
	...
	/**
	 * The name of the parameter that will specify the name of the static
	 * resource to fetch.
	 */
	...
	/**
	 * Service an HTTP request. The
	 * {@link #serviceInt(HttpServletRequest, HttpServletResponse)} method is
	 * called to do the actual servicing. If the serviceInt method throws an
	 * exception, it is caught and the user is shown a generic error page using
	 * the
	 * {@link #handleError(HttpServletRequest, HttpServletResponse, Throwable)}
	 * method.
	 *
	...
	/**
	 * Service internal. This method does the real work in servicing the http
	 * request. It integrates wcomponents into a servlet environment via a
	 * servlet specific helper class.
	 *
	...
	/**
	 * The interceptor component returned here is used to wrap the html fragment
	 * generated by the UI component.
	 *
	 ...
	 * <p>
	 * It is up to the subclass to determine the life cycle of the returned
	 * component. Should the same instance be returned and shared by all
	 * sessions, or should there be a new instance per session.
	 * <p>
	 * A good way to always return the same instance is to use the UIRegistry.
	 * E.g.
	 *
	 * <pre>
	 ...
	 * <p>
	 * Chiefly it handles the creation and storage of each users
	 * {@link UIContext} in the servlet session, and it maps servlet requests
	 * and responses to wcomponent requests and responses.
	 * </p>
	 * <p>
	...
	public static class WServletEnvironment extends HttpServletEnvironment {
		 ...
		 */
		public WServletEnvironment(final String postPath, final String baseUrl, final String userAgent) {
		 ...
		 */
		public WServletEnvironment(final String postPath, final String baseUrl, final UserAgentInfo userAgentInfo) {
