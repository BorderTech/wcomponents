...
/**
 * Helper class used to provide common functionality for <code>Comparator</code> instances used by
 * e.g. table sorting.
 *
 * @author Adam Millard
 */
public abstract class AbstractComparator implements Comparator, Serializable {
	...
	/**
	 * Subclasses must implement this method to obtain a derived comparable to use for comparison. A
	 * trivial implementation would be to return the object itself if it is already a
	 * {@link Comparable}.
	 *
