 ...
 * store their data locally. Models implementing this interface can provide more
 * efficient calls to back-end systems, as the data model is notified of which
 * rows are likely to be used in the near future.
 *
...
public interface ScrollableTableDataModel extends TableDataModel {
	...
	/**
	 * This method will be called by the table to notify the TableDataModel of
