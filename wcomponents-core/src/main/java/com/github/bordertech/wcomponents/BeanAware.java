...
/**
 * The super-interface for "bean-aware" components. Components should normally
 * not implement this interface, but either {@link BeanBound} or
 * {@link BeanProviderBound}, as those interfaces provide methods of supplying
 * the bean.
 *
...
public interface BeanAware {
	...
	/**
	 * Retrieves the value this component is interested in from the bean. This
	 * is derived from the {@link #getBeanProperty()} and {@link #getBean()}.
	 *
