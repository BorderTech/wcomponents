...
public final class RequestUtil {
	...
	/**
	 * Add the file data to the files collection. If a file already exists with
	 * the given name then the value for this name will be an array of all
	 * registered files.
	 *
	...
	/**
	 * Add the request parameter to the parameters collection. If a parameter
	 * already exists with the given name then the Map will contain an array of
