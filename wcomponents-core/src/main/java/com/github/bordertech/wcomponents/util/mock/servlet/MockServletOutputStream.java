...
public class MockServletOutputStream extends ServletOutputStream {
	...
	/**
	 * The backing output stream to write content to, so that it may later be
	 ...
	 * is the eight low-order bits of the argument <code>b</code>. The 24
	 ...
	 *
	 * @return the byte data written to the stream. May be empty, but will not
	 * be null.
	 */
