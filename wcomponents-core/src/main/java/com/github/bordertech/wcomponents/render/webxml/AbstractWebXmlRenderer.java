 ...
 * 
 * All web xml renderers should extend this class, and must be thread-safe,
 * as only a single instance of the renderer is created by the UIManager. 
 * It is recommended that renderers do not keep any state information, 
 * to avoid the performance penality of having to synchronize methods.
 * 
