...
/**
 * Represents a video. Implementations can choose whether to explicitly store the byte[] or fetch it
 * from some sort of streaming resource as needed to service the {@link #getBytes} and
