...
/**
 * This session token interceptor makes sure the request being processed is for
 * the correct session.
 * <p>
 * As the token is a UUID, it will be much harder for CSRF attacks. No request
 * processing will occur without the correct UUID.
 * </p>
 *
