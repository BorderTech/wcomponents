...
/**
 * This abstract impements the Container interface to expose methods for
 * retrieving the contents of the container. This class is extended by most
 * WComponents which contain other components
 *
