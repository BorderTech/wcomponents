...
{    
    ...
    private static final String WEBDOCS_DIR_PARAM = "wcomponent.lde.webdocs.dir";
    
    /** This configuration parameter allows the developer to configure the LDE to use an external theme. */
    private static final String WEBDOCS_THEME_DIR_PARAM = "wcomponent.lde.theme.dir";
    
    /** This configuration parameter allows the developer to configure the LDE to set a resources directory. */
    private static final String WEBDOCS_RESOURCE_DIR_PARAM = "wcomponent.lde.resource.dir";
    
    /** This configuration parameter sets which port the LDE runs on. */
    private static final String JETTY_PORT_PARAM = "wcomponent.lde.server.port";
    
    /** This configuration parameter sets up the Jetty realm file for authenticated access. */
    private static final String JETTY_REALM_FILE_PARAM = "wcomponent.lde.server.realm.file";
    
    /** This configuration parameter sets up the Jetty realm file for authenticated access. */
    private static final String ENABLE_SHUTDOWN_PARAM = "wcomponent.lde.shutdown.enabled";

    /** This configuration parameter sets the Jetty session timeout interval. */
    private static final String SESSION_TIMEOUT_PARAM = "wcomponent.lde.session.inactive.interval";
    ...
    protected WebAppContext createWebApp(final Server server) throws Exception
    {
        ...
        if (themeWebdocs == null)
        {
            ...
            themeWebapp.addServlet("com.github.dibp.wcomponents.servlet.ThemeServlet", "/*");
    ...
    {
        //webapp.addServlet("themeServlet", "/theme/*", "com.github.dibp.wcomponents.lde.LdeThemeServlet");
    }
