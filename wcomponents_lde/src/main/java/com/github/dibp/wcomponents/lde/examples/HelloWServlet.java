package com.github.dibp.wcomponents.lde.examples;
...
import com.github.dibp.wcomponents.servlet.ThemeServlet;
import com.github.dibp.wcomponents.servlet.WServlet;

/**
 * <p>This class demonstrates how to run a WComponent from a Servlet.
 * Simply extend WServlet and implement the method getUI()
 * to return a WComponent. In this case we return a really simple
 * WComponent called a WLabel. Of course you could return a complex
 * component that represents an entire web application.</p> 
 * 
 * <p>To see it work, run this class (it has a main), start a browser and
 * enter the url "http://localhost:8080/".</p>
 * 
...
public class HelloWServlet extends WServlet
{
    ...
    /**
     * This main method exists to make it easy to run this servlet without
     * having to create a web.xml file, build a war and deploy it.
     * 
