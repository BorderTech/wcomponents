...
import com.github.dibp.wcomponents.monitor.ProfileContainer;
 ...
 *
 * <pre>
 * ui.web.component.to.launch = com.github.dibp.wcomponents.examples.picker.ExamplePicker
 * </pre>
 *
        ...
        if (uiClassName == null)
        {
            sharedApp = new WText(
                "You need to set the class name of the WComponent you want to run.<br />"
                    ...
                    + "Eg.  <code>" + COMPONENT_TO_LAUNCH_PARAM_KEY + "=com.github.dibp.wcomponents.examples.picker.ExamplePicker</code>");
