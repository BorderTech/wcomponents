...
import com.github.openborders.examples.petstore.PetStoreLookupTable;
...
public class CrtBeanProvider_Test
{
    ...
    public static void setUp()
    {
        ...
        config.setProperty("wcomponent.factory.impl.com.github.openborders.util.LookupTable", PetStoreLookupTable.class.getName());
