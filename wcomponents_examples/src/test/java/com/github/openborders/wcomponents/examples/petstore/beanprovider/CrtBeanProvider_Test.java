...
import com.github.openborders.wcomponents.examples.petstore.PetStoreLookupTable;
...
public class CrtBeanProvider_Test
{
    ...
    public static void setUp()
    {
        ...
        config.setProperty("wcomponent.factory.impl.com.github.openborders.wcomponents.util.LookupTable", PetStoreLookupTable.class.getName());
