...
public class WDialogExample_Test extends WComponentSeleniumTestCase
{
    ...
    public void testModalDialogNotPresentOnLoad()
    {
        ...
        String expectedText = WDialogExample.getModalText();
    ...
    public void testModalDialog()
    {
        ...
        WebDriver driver = getDriver();
        String expectedText = WDialogExample.getModalText();
        final WButton testButton = WDialogExample.getModalButton();
...
//        Assert.assertTrue("Should have a validation error", driver.getPageSource().contains("Please select a name from the list"));
    ...
    public void testModelessDialogNotPresentOnLoad()
    {
        // Launch the web browser to the LDE
        WebDriver driver = getDriver();
        String expectedText = WDialogExample.getNonModalText();
        Assert.assertFalse("Should not be displaying the dialog", driver.getPageSource().contains(expectedText));
    }
    @Test
    public void testModelessDialog()
    {
        ...
        WebDriver driver = getDriver();
        String expectedText = WDialogExample.getNonModalText();
        final WButton testButton = WDialogExample.getNonModalButton();
