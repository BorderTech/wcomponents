...
import com.github.openborders.WTab;
...
public class WTabExample extends WPanel
{
    ...
    public WTabExample()
    {
        ...
        tabset1.setMargin(new com.github.openborders.Margin(0, 0, 24, 0));
        add(tabset1);
        ...
        add(tabset5);
        tabset5.setMargin(new com.github.openborders.Margin(0, 0, 24, 0));
        ...
        add(tabset6);
        tabset6.setMargin(new com.github.openborders.Margin(0));
    ...
    private static final class SampleTabSet extends WTabSet
    {
        ...
        private void init()
        {
            setMargin(new com.github.openborders.Margin(0, 0, 24, 0));
