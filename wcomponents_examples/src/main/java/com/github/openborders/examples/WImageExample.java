...
public class WImageExample extends WPanel
{
    ...
    public WImageExample()
    {
        ...
        final ImageResource bannerImage = new ImageResource("/com/github/openborders/examples/picker/wclogo_small.gif", "Logo");
        ...
        final ExampleImage portraitImage = new ExampleImage("com/github/openborders/examples/portlet-portrait.jpg");
