...
public class WContentExample extends WPanel
{
    ...
    public WContentExample()
    {
        ...
        addContentRow("View GIF",  new InternalResource("/com/github/openborders/examples/picker/wclogo_small.gif", "example.gif"), this);
        
        // Some content which browsers may be able to display using a plugin.
        addContentRow("View PDF",  new InternalResource("/com/github/openborders/examples/test.pdf", "example.pdf"), this);
        ...
        addContentRow("View TR5",  new InternalResource("/com/github/openborders/examples/test.tr5", "example.tr5"), this);
