...
import com.github.openborders.examples.petstore.model.PlaceOrderService.OrderStatus;
...
public class PetStoreApp extends WApplication implements MessageContainer
{
    ...
    static
    {
        ...
        try
        {
            ...
            properties.load(PetStoreApp.class.getResourceAsStream("/com/github/openborders/examples/petstore/resources/petstore.properties"));
