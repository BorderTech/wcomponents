...
import com.github.openborders.WList.Separator;

import com.github.openborders.examples.common.SimpleTableBean;
...
public class WListOptionsExample extends WPanel
{
    ...
    private WFieldSet getListControls()
    {
        ...
        apply.setAction(new com.github.openborders.Action()
        {
    ...
    {
        container.reset();
        WList list = new WList((com.github.openborders.WList.Type) ddType.getSelected());
