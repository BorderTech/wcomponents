...
public class KitchenSink extends WPanel
{
     ...
     * 
     * Tabs are set to be client-side so we can test the rendering performance 
     * of all of the components in one hit.
     */
     ...
     * It adds TextDuplicators or copies of itself, depending on which button is pressed. 
     */
    public static class DuplicatorGroup extends WPanel
    {
         ...
         * Normally, applications should be adding Actions to WButtons rather than 
         * overriding this method. See the KitchenSink's resetButton for an example. 
         * 
        ...
        public void handleRequest(final Request request)
        {
            ...
            {
                dupPanel.add(new TextDuplicator_HandleRequestImpl("Duplicator "
