...
public class WMultiSelectPairExample extends WContainer
{
    ...
    /**
     * A panel which can be easily configured to demonstrate different 
     * configurations of a WMultiSelectPair.
     */
    private static final class ExamplePanel extends WContainer
    {
         ...
         */
        public ExamplePanel(final String[] options, final boolean shuffle)
        {
         ...
         * @param shuffle whether to enable option shuffling for the multi-select pair.
         */
        public ExamplePanel(final List options, final boolean shuffle)
        {
        ...
        /**
         * Override prepaprePaintComponent to initialise the example the first time through.
         * This just sets the text of the text area to match the initial selections.
         * 
