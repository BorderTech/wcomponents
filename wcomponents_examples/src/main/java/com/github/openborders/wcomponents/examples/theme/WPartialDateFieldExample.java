...
public class WPartialDateFieldExample extends WPanel
{
    ...
    public WPartialDateFieldExample()
    {
        ...
        buttonPanel.setMargin(new com.github.openborders.wcomponents.Margin(6,0,24,0));
        ...
        setDateButtonPanel.setMargin(new com.github.openborders.wcomponents.Margin(6,0,0,0));
