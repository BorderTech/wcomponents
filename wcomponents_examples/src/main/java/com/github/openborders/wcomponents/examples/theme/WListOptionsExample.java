...
import com.github.openborders.wcomponents.WList.Separator;
...
public class WListOptionsExample extends WPanel
{
    ...
    private WFieldSet getListControls()
    {
        ...
        apply.setAction(new com.github.openborders.wcomponents.Action()
        {
    ...
    {
        container.reset();
        WList list = new WList((com.github.openborders.wcomponents.WList.Type) ddType.getSelected());
