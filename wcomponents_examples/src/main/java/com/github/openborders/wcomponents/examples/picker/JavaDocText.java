...
/**
 * <p>
 * JavaDocText is a simple component to render the javaDoc from the example
 * classes into a WComponent.
 * </p>
 * 
...
public class JavaDocText extends WText
{
    ...
    /**
     * extracts the javadoc.  It assumes that the java doc for the class
     * is the first javadoc in the file. 
     * 
