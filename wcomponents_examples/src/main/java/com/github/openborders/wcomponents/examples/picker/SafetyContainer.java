...
import com.github.openborders.wcomponents.AbstractMutableContainer;
import com.github.openborders.wcomponents.ActionEscape;
import com.github.openborders.wcomponents.ComponentModel;
import com.github.openborders.wcomponents.MutableContainer;
...
final class SafetyContainer extends AbstractMutableContainer
{
    ...
    /**
     * Override handleRequest in order to safely process the example component,
     * which has been excluded from normal WComponent processing.
     * 
    ...
    /**
     * <p>Override preparePaintComponent to provide some protection against bad code
     * when examples are being developed, resulting in invalid XML.</p>
     * 
     * <p>Real applications should not emit HTML directly.</p>
     * 
     * @param request the request being responded to.
     */
    @Override
    ...
    /**
     * <p>Override paintComponent to provide some protection against bad code
     * when examples are being developed, resulting in invalid XML.</p>
     * 
     * <p>Real applications should not emit HTML directly.</p>
     * 
    ...
    /**
     * We need to keep the Example's invoke later actions separate from the rest,
     * so this delegate keeps its own list of runnables.
     */
    private static final class SafetyContainerDelegate extends UIContextDelegate
    {
         ...
         */
        public SafetyContainerDelegate(final UIContext uic)
        {
            super(uic);
        }
