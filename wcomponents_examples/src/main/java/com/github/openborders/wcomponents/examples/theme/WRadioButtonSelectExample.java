...
import com.github.openborders.wcomponents.Option;
...
public class WRadioButtonSelectExample extends WPanel
{
    ...
    /**
     * When a WRadioButtonSelect is added to a WFieldLayout the legend is moved.
     * The first CheckBoxSelect has a frame, the second doesn't
     * 
     */
    ...
    /**
     * adds a WRadioButtonSelect with LAYOUT_COLUMN in 1 column
     * simply by not setting the number of columns. This is superfluous as
     * you should use LAYOUT_STACKED (the default) instead.
     */
    ...
    /**
     * Examples of readonly states. When in a read only state only the selected
     * option is output. Since a WRadioButtonSeelct can only have 0 or 1 selected
     * option the LAYOUT and FRAME are ignored.
     */
    ...
    /**
     * Examples of disabled state. You should use {@link WSubordinateControl}
     * to set and manage the disabled state unless there is no facility for the
     * user to enable a control.
     * 
