...
import com.github.openborders.wcomponents.util.LookupTable;

/** 
 * CrtBeanProvider is a beanProvider that provides data from a CRT.
 * The provider can be used to look-up a single or multiple entries,
...
public class CrtBeanProvider implements BeanProvider
{
    ...
    /** 
     * The table code that will be used to look up the value. If null, 
     * the bound component will provide the code. 
     */
    private final String tableCode;
 
    /**
     * Creates a CrtBeanProvider that will use the given Crt, 
     * and the code from the bound component. The value returned
     * by this provided will vary depending on the Crt and
     * bound component.
     * 
     ...
     * This provider will then only return one value from the Crt.
     * 
     * @param lookupTableName the Crt name.
