...
import com.github.openborders.wcomponents.ContentAccess;
...
import com.github.openborders.wcomponents.WContentLink;
...
import com.github.openborders.wcomponents.WContent.DisplayMode;
import com.github.openborders.wcomponents.layout.GridLayout;

/**
 * Demonstrates the use of {@link WContent} and {@link WContentLink} for
 * displaying arbitrary binary files.
 *
...
public class WContentExample extends WPanel
{
    ...
    public WContentExample()
    {
        ...
        addContentRow("View GIF",  new InternalResource("/com/github/openborders/wcomponents/examples/picker/wclogo_small.gif", "example.gif"), this);

        // Some content which browsers may be able to display using a plugin.
        addContentRow("View PDF",  new InternalResource("/com/github/openborders/wcomponents/examples/test.pdf", "example.pdf"), this);
        ...
        addContentRow("View TR5",  new InternalResource("/com/github/openborders/wcomponents/examples/test.tr5", "example.tr5"), this);
