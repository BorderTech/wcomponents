package com.github.openborders.wcomponents.examples.petstore.model; 

/** 
 * A dummy DAO for the PetStore. There is only one copy of the hard-coded data, so that the 
 * data at least appears to be updated when a single user interacts with the app.  
 * 
...
public final class PetStoreDao
{
    ...
    private static final class DummyData
    {
        ...
        /**
         * Returns the list of products. New instances of each product are returned, to emulate data expiring from the cache.
        ...
        /**
         * Returns the list of inventory. New instances of each inventory are returned, to emulate data expiring from the cache.
