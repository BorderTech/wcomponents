...
import com.github.openborders.wcomponents.ScrollableTableDataModel;
...
public class ScrollableDataTableModelExample extends WPanel
{
    ...
    public static final class MyTableDataModel extends AbstractTableDataModel implements ScrollableTableDataModel
    {
        ...
        /**
         * <p>This method will be called by the table to notify the TableDataModel
         * of which rows are likely to be used in the near future.</p>
         * 
         * <p>This example implementation asks the service to return a sub-set
         * of data, for the current page being displayed.</p>
         *  
