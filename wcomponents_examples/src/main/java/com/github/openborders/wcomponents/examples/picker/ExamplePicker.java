 ...
 *
 * <pre>
 * com.github.openborders.wcomponents.examples.picker.ExamplePicker.ui = com.github.openborders.wcomponents.examples.picker.SimplePicker
 * </pre>
 *
...
public class ExamplePicker extends WApplication
{
    ...
    private static final String PARAM_KEY = "com.github.openborders.wcomponents.examples.picker.ExamplePicker.ui";
    ...
    protected void preparePaintComponent(final Request request)
    {
        ...
        if (!isInitialised())
        {
            ...
            javascript.setContentAccess(new InternalResource("/com/github/openborders/wcomponents/examples/syntaxHighlight.js", "syntaxHighlight.js"));
            css.setContentAccess(new InternalResource("/com/github/openborders/wcomponents/examples/syntaxHighlight.css", "syntaxHighlight.css"));
            setInitialised(true);
        }
