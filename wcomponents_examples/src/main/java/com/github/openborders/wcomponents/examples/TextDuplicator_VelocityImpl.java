...
public class TextDuplicator_VelocityImpl extends WContainer
{
    ...
    public TextDuplicator_VelocityImpl(final String name)
    {
        ...
        // In this case, com.github.openborders.wcomponents.examples.TextDuplicatorPretty
        // maps to the template com/github/openborders/wcomponents/examples/TextDuplicator_VelocityImpl.vm
