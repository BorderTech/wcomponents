...
public class LinkOptionsExample extends WPanel
{
    ...
    public LinkOptionsExample()
    {
        ...
        List<ImagePosition> positions = new ArrayList<ImagePosition>(Arrays.asList(WLink.ImagePosition.values()));
    ...
    private WFieldSet getButtonControls(final WValidationErrors errors)
    {
        ...
        layout.setMargin(new com.github.openborders.wcomponents.Margin(0, 0, 6, 0));
