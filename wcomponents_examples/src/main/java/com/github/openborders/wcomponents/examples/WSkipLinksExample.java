...
/** 
 * <p>This example demonstrates the {@link WSkiplinks} component.</p>
 * 
 * <p>WSkipLinks is a component which has a heading and a list of internal links. 
 * These links will move the cursor point to the first focusable element within 
 * a WPanel which has an accessKey set.</p>
 * 
