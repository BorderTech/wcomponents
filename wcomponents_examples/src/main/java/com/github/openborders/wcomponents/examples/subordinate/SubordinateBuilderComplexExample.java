...
import com.github.openborders.wcomponents.examples.TextImage;
...
public class SubordinateBuilderComplexExample extends WContainer
{
    ...
    private static final class CreditCardPanel extends WPanel
    {
        ...
        private WContainer createDatePicker()
        {
            ...
            List<String> months = new ArrayList<String>(Arrays.asList(MONTH_NAMES));
            months.add(0, null);
    ...
    /**
     * An example panel which provides instructions on how to complete the transaction.
     * This panel does not contain any subordinate logic.
     */
