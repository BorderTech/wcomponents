...
import com.github.openborders.wcomponents.WProgressBar.ProgressBarType;
import com.github.openborders.wcomponents.WProgressBar.UnitType;
...
public class WProgressBarExample extends WPanel
{
    ...
    private static final class ProgressBarWithButtons extends WPanel
    {
         ...
         */
        public ProgressBarWithButtons(final WProgressBar bar)
        {
