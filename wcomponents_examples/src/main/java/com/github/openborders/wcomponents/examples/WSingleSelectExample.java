...
public class WSingleSelectExample extends WContainer
{
    ...
    public WSingleSelectExample()
    {
        ...
        List<PersonOption> peopleOptions = new ArrayList<PersonOption>();
    ...
    /**
     * Applications can wrap options inside lists in order to provide
     * custom text and values for the drop down.
     */
    private static final class PersonOption implements Option, Serializable
    {
         ...
         */
        public PersonOption(final Person person)
        {
            this.person = person;
        }
