...
public class WDropdownOptionsExample extends WContainer
{
    ...
    private WFieldSet getDropDownControls()
    {
        ...
        WField subField = layout.addField("Subordinate", cbSubordinate);//.getLabel().setHint("Does not work with Dropdown Type COMBO");
    ...
    private void applySettings()
    {
        ...
        List<String> options = new ArrayList<String>(Arrays.asList(OPTIONS_ARRAY));
