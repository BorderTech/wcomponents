...
/** 
 * This example demonstrates a simple editable table
 * where only one row is allowed to be edited at a time.
 * 
...
public class SimpleRowEditingTableExample extends WPanel
{
    ...
    /**
     * An extension of SimpleTableDataModel which allows editing of a single row,
