...
import com.github.openborders.wcomponents.AbstractTableDataModel;
import com.github.openborders.wcomponents.AbstractTreeTableDataModel;
...
import com.github.openborders.wcomponents.TableTreeNode;
import com.github.openborders.wcomponents.TreeTableDataModel;
...
import com.github.openborders.wcomponents.util.AbstractComparator;
...
public class DataTableOptionsExample extends WContainer
{
    ...
    {
        EnumerationRadioButtonSelect<T> rbSelect = new EnumerationRadioButtonSelect<T>(options);
     ...
     * 
     * @param table
     *            the table with selected items
     * @param selected
     *            the text field that will contain a copy of the selected item
     *            details
     */
    ...
    public static class ExampleBean implements Serializable
    {
         ...
         * 
         * @param column1
         *            the data for column1
         * @param column2
         *            the data for column2
         * @param column3
         *            the data for column3
         */
    ...
    public static final class ExtraDetailsNode extends TableTreeNode
    {
         ...
         * 
         * @param extra
         *            the bean for the expanded content.
         */
    ...
    public static final class ExtraBean implements Serializable
    {
         ...
         * 
         * @param columnA
         *            the data for columnA
         * @param columnB
         *            the data for columnB
         * @param columnC
         *            the data for columnC
         */
    ...
    /**
     * A simple extension of WRadioButtonSelect to enhance type safety and 
     * provide a more intelligent description of the enumerated values.
     * 
     * @param <T> the enumeration type. 
     */
    private static final class EnumerationRadioButtonSelect<T extends Enum<T>> extends WRadioButtonSelect 
    {
         ...
         */
        public EnumerationRadioButtonSelect(final T[] options)
        {
            super(options);
        }
