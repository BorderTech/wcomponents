...
public class TreePicker extends WPanel implements MessageContainer
{
    ...
    public TreePicker()
    {
        ...
        //WImage logo = new WImage("/com/github/openborders/wcomponents/examples/picker/wclogo_small.gif", "WComponents examples");
...
//        });
		...
		mainPanel.setMargin(new com.github.openborders.wcomponents.Margin(COL_HGAP));
