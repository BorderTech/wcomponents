...
import com.github.openborders.wcomponents.WProgressBar;
...
public class WLabelExample extends WPanel
{
    ...
    public WLabelExample()
    {
        ...
        fieldsFlat.setMargin(new com.github.openborders.wcomponents.Margin(0, 0, 24, 0));
        add(fieldsFlat);
        ...
        errorLayoutPanel.setMargin(new com.github.openborders.wcomponents.Margin(0, 0, 24, 0));
