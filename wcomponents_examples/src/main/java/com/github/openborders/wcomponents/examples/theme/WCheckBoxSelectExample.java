 ...
 * @since 1.0.0
 * @since 1.0.0
 *        using defaul buttons and ajax controls.
 */
public class WCheckBoxSelectExample extends WContainer
{
    ...
    /**
     * adds a WCheckBoxSelect with LAYOUT_FLAT
     */
    ...
    private static final class CarOption implements Option, Serializable
    {
         ...
         */
        public CarOption(final String id, final String make, final String model)
        {
    ...
    private static final class Car implements Serializable
    {
         ...
         * @param model the model of the car
         */
        public Car(final String id, final String make, final String model)
        {
            this.id = id;
            this.make = make;
            this.model = model;
