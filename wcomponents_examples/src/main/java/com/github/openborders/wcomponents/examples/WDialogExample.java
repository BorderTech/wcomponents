...
import com.github.openborders.wcomponents.WDialog;
 ...
 * @author Mark Reeves
 * @since 1.0.0
 * Added many examples and reordered the examples so that the preferred mechanism
 * for opening a dialog is the primary example.
 */
public class WDialogExample extends WPanel implements MessageContainer
{
    ...
    /**
     * This text is used for automated testing ONLY. It is used to test for a 
     * specific piece of content in a modal dialog to show that the dialog has
     * opened. It is not necessary for the functioning of the example dialogs
     * that this text be specified. */
    private final static String MODAL_TEXT = "Modal dialog example";
    /**
     * This text is used for automated testing ONLY. It is used to test for a 
     * specific piece of content in a modal dialog to show that the dialog has
     * opened. It is not necessary for the functioning of the example dialogs
     * that this text be specified. */
    private final static String NON_MODAL_TEXT = "Non-modal dialog example";
    
    /** WButton used to launch an immediate modal dialog */
    private static WDialog modalDialog;
    /** WButton used to launch an immediate non-modal dialog */
    private static WDialog nonModalDialog;
    ...
    private static final class ViewPersonList extends WDefinitionList
    {
        ...
        /**
         * Override preparePaintComponent in order to set some content which
         * varies according to the modality of the containing dialog
         * 
    ...
    /**
     * <p>An example panel which is used to search/select a person.</p>
     *
     * <p>This demonstrates "conversational" dialog content, where AJAX
     * is used to update components within the dialog, and the dialog
     * has validation to ensure the entered data is valid.</p>
     *
     * <p>This also demonstrates the use of a "chained" action, where
     * another action is invoked from the executeOnValid part of a
     * validating action.</p>
     */
    private static final class SelectPersonPanel extends WPanel implements MessageContainer
    {
        ...
        public SelectPersonPanel()
        {
            ...
            buttonPanel.setMargin(new com.github.openborders.wcomponents.Margin(12, 0, 0, 0));
            add(buttonPanel);
        ...
        private static final class SearchFieldSet extends WFieldSet
        {
             ...
             */
            public SearchFieldSet()
            {
                super("Search for person");
                setMargin(new com.github.openborders.wcomponents.Margin(0, 0, 12, 0));
    ...
    /**
     * Get the modal dialog marker text. This is used for automated testing only
     * and is not part of the example.
     * @return the modal marker text
     */
    public final static String getModalText()
    {
        return MODAL_TEXT;
    }

    /**
     * Get the non-modal dialog marker text. This is used for automated testing
     * only and is not part of the example.
     * @return the non-modal marker text
     */
    public final static String getNonModalText()
    {
     ...
     */
    public final static WButton getModalButton()
    {
        return (WButton) modalDialog.getTrigger();
    }
    public final static WButton getNonModalButton()
    {
