...
import com.github.openborders.wcomponents.SimpleBeanTreeTableDataModel;
...
import com.github.openborders.wcomponents.WNamingContext;
...
import com.github.openborders.wcomponents.WPanel.PanelMode;
import com.github.openborders.wcomponents.WRadioButtonSelect.Layout;
...
public class TableLoadPerformance extends WApplication
{
     ...
     * Results panel.
     */
    private static class MyResults extends WPanel
    {
         ...
         */
        public MyResults(final MyTimingShim shim)
        {
            this.shim = shim;
     ...
     */
    private static class MyTimingShim extends WContainer
    {
         ...
         */
        public MyTimingShim(final WComponent content)
        {
