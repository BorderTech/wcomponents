...
/**
 * A service to place an order. For a real application, this should be an EJB 
 * or ESB/point-to-point service, accessed through a DMS.  
 * 
...
public final class PlaceOrderService
{
    ...
    public OrderStatus placeOrder(final List<CartBean> cart, final ConfirmOrderBean clientDetails)
    {
        ...
        synchronized (lock)
        {
            ...
            return new OrderStatus(OrderStatus.SUCCESS, Integer.valueOf(orderSequenceNumber++), null);
        }
    }
