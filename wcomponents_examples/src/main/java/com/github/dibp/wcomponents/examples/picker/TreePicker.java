...
public class TreePicker extends WPanel implements MessageContainer
{
    ...
    public TreePicker()
    {
        ...
        //WImage logo = new WImage("/com/github/dibp/wcomponents/examples/picker/wclogo_small.gif", "WComponents examples");
...
//        });
		...
		mainPanel.setMargin(new com.github.dibp.wcomponents.Margin(COL_HGAP));
