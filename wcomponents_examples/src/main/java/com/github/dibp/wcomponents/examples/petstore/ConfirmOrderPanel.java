...
import com.github.dibp.wcomponents.WMessagesValidatingAction;
...
import com.github.dibp.wcomponents.validation.WFieldErrorIndicator;
import com.github.dibp.wcomponents.validator.AbstractFieldValidator;

import com.github.dibp.wcomponents.examples.petstore.beanprovider.CrtBeanProvider;
import com.github.dibp.wcomponents.examples.petstore.model.CartBean;
import com.github.dibp.wcomponents.examples.petstore.model.InventoryBean;
import com.github.dibp.wcomponents.examples.petstore.model.PetStoreDao;

/** 
 * ConfirmOrderPanel allows a user to confirm their order and enter shipping
 * and payment details. 
 * 
...
public class ConfirmOrderPanel extends WBeanContainer
{
    ...
    /**
     * A convenience class to reduce the amount of code necessary
     * to add a field, label and error indicator. The labels and
     * fields are displayed with a 20%/80% column split.
     * 
     * @author Yiannis Paschalidis
     */
