...
public class WTextExample extends WPanel
{
    ...
    {
        /**
         * This method is called whenever the BeanProviderBound component wants
         * to access the Bean. The id (cache key, primary key, etc.) is retrieved
         * from the component. This implementation just "fakes" a service call.
         * 
