...
public class ExampleDataUtil
{
    ...
    {
        List<PersonBean> data = new ArrayList<PersonBean>(5);
    ...
    {
        List<PersonBean> data = new ArrayList<PersonBean>(rows);
        ...
        for (int i = 1; i <= rows; i++)
        {
            ...
            List<TravelDoc> docs = new ArrayList<TravelDoc>(documents);
