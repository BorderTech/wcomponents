...
public class NavigationBar extends WPanel
{
    ...
    private static final class ContinueShoppingButton extends WButton
    {
        ...
        /**
         * Override isVisible to dynamically change the visibility
         * without needing to store anything in the session.
         * 
    ...
    private static final class CartButton extends WButton
    {
        ...
        /**
         * Override isDisabled to dynamically enable/disable navigation
         * depending on the contents of the cart.
         * 
