...
/** 
 * This example shows the use of a {@link WDataTable} with a list of editable beans.
 * All bean binding logic for the table column renderers is performed by the data model.
 * 
