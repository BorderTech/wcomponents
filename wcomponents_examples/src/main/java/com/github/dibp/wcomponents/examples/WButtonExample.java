...
public class WButtonExample extends WPanel implements MessageContainer
{
    ...
    public WButtonExample()
    {
        ...
        // Plain button
        add(new WHeading(WHeading.MAJOR, "Plain button"));
        add(plainBtn);
        ...
        add(new WHeading(WHeading.MAJOR, "Button with actions"));
    ...
    /**
     * An example to cover the gamut of image buttons both with and without visible text and with both renderAsLink and render as button.
     */
    private void addImageExamples()
    {
        // Button rendered with an image only
        add(new WHeading(WHeading.MAJOR, "Image buttons"));
     ...
     * @return a button
     */
    private WButton makeImageButtonWithPosition(String text, ImagePosition pos, Boolean asLink)
    {
     ...
     * @return a button
     */
    private WButton makeImageButtonWithPosition(String text, ImagePosition pos)
    {
    ...
    * @return a button
    */
    private WButton makeImageButton(String text, Boolean asLink)
    {
    ...
    private void addAntiPatternExamples()
    {
        ...
        add(new WHeading(WHeading.SECTION, "WButton with a WImage but without a good label"));
