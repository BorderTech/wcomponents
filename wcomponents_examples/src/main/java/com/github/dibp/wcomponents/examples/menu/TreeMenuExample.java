...
import com.github.dibp.wcomponents.WMenuItemGroup;
...
public class TreeMenuExample extends WPanel
{
    ...
    private static StringTreeNode createExampleHierarchy()
    {
        ...
        Map<String, StringTreeNode> nodeMap = new HashMap<String, StringTreeNode>();
    ...
    /**
     * Tree menu containing image in the items. This example demonstrates
     * creating {@link WSubMenu} and {@link WMenuItem} components with
     * {@link WDecoratedLabel}.
     */
