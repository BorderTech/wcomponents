...
import com.github.dibp.wcomponents.examples.petstore.model.ProductBean;
...
public class ProductImage implements Image
{
    ...
    private static final String IMAGE_PATH = "com/github/dibp/wcomponents/examples/petstore/resources/images/";
    ...
    /**
     * Retrieves the natural size of the image. If only one dimension is known,
     * a negative value will be returned for the other dimension.
     *
    ...
    /**
     * Sets the natural size of the image. If only one dimension is known,
     * use a negative value for the other dimension. If the image size is
     * unknown, set the size to null.
     *
    ...
    /**
     * Retrieves some text that describes the image, for example
    ...
    /**
     * Sets some text that describes the image, for example
     * the document filename or title.
     *
