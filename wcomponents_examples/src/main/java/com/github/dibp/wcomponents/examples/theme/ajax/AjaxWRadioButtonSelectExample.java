...
/**
 * In this example the {@link WRadioButtonSelect} is 
 * made AJAX aware to update the content of a {@link WPanel}.
 * 
 * @since 1.0.0
...
public class AjaxWRadioButtonSelectExample extends WPanel
{
    ...
    private final static String OPTION_CONTENT1 = "Content1";
    
    /** Second option for the RadioButtonSelect. */
    private final static String OPTION_CONTENT2 = "Content2";

    
    /** Second option for the RadioButtonSelect. */
    private final static String OPTION_CONTENT3 = "Content3";
