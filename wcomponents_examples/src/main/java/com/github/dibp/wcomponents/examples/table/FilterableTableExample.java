...
import com.github.dibp.wcomponents.WSubMenu;
...
public class FilterableTableExample extends WContainer
{
     ...
     * @param caseInsensitive If true the filter will not be case sensitive so, for example, "Smith" and "smith" will be equivalent. 
     */
    public void setCaseSensitiveMatch(Boolean caseInsensitive)
    {
     ...
     * @param COLUMN The column index of the table column the menu is in. This is used to get the data off the table's Bean
     *     to put text content into the menu's items.
     */
     ...
     */
    @SuppressWarnings("serial")
    private class FilterableBeanBoundDataModel extends SimpleBeanBoundTableModel
    {
        ...
        private Boolean CASE_INSENSITIVE_MATCH = true;
        
        public FilterableBeanBoundDataModel(String[] columnBeanProperties)
        {
        ...
        /**
         * Helper to get a bean property value from the unfiltered bean list. Basically it just makes getBeanPropertyValue
         * public.
        ...
        public void filterBeanList()
        {
            ...
            List<WComponent> selectedItems = new ArrayList<WComponent>();
            ...
            if (selectedItems.isEmpty())// no filter applied or filters removed
            {
                filteredList = fullList;
            }
            else
        ...
        public void setCaseSensitiveMatch(Boolean caseInsensitive)
        {
            this.CASE_INSENSITIVE_MATCH = caseInsensitive;;
        }
         ...
         */
        private List<?> filterBeanList(List<?> beanList)
        {
