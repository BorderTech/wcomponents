...
/**
 * <p>
 * This component demonstrates the usage of the {@link WFieldLayout},
 * components. These are in the following configurations. </p>
 *
 * <p>
 * <ul>
 * <li>Flat (Default)</li>
 ...
 *
 * <p>
 * This also demonstrates the behaviour of the {@link WCheckBox} within a
 * {@link WCheckBox}.
 * </p>
 *
 * @author Adam Millard
...
public class WFieldLayoutExample extends WPanel {
    ...
    private WFieldLayout recursiveFieldLayout(int i, int startAt) {
        ...
        if (i < 4) {
            ++i;
            innerLayout.addField("indent level " + String.valueOf(i), recursiveFieldLayout(i, 0));
        }
