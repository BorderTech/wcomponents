...
import com.github.dibp.wcomponents.HeadingLevel;
...
import com.github.dibp.wcomponents.WProgressBar;
...
/**
 * <p>This component demonstrates the use and abuse of {@link WLabel}.</p>
 * @author Mark Reeves
 * @since 1.0.0
 */
public class WLabelExample extends WPanel
{
    ...
    public WLabelExample()
    {
        ...
        fieldsFlat.setMargin(new com.github.dibp.wcomponents.Margin(0, 0, 24, 0));
        add(fieldsFlat);
         ...
         */
        String LABEL_TEXT = "Enter the dates of entry and exit";//we re-use this string for both the WLabel and the WFieldSet's label
        //make a WFieldSet
        WFieldSet dateRangeFS = new WFieldSet(LABEL_TEXT);
        ...
        fieldsFlat.addField(LABEL_TEXT,dateRangeFS);
        ...
        errorLayoutPanel.setMargin(new com.github.dibp.wcomponents.Margin(0, 0, 24, 0));
         ...
         */
        add(new WHeading(HeadingLevel.H3, "Very bad uses of WLabel"));errorLayoutPanel = new WPanel();
        errorLayoutPanel.setLayout(new FlowLayout(FlowLayout.VERTICAL,0,12));
        add(errorLayoutPanel);
