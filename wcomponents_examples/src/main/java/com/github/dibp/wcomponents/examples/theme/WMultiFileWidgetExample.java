...
import com.github.dibp.wcomponents.WMultiFileWidget;
...
import com.github.dibp.wcomponents.WMultiFileWidget.FileWidgetUpload;
import com.github.dibp.wcomponents.layout.FlowLayout;
import com.github.dibp.wcomponents.layout.FlowLayout.Alignment;

/**
 * <p>Example use of the {@link WMultiFileWidget} component.
 * </p>
 * <p>
 * WMultiFileWidget allows user to upload multiple files.
 * File information is rendered for each upload.
 * The file link pops up a window to show the uploaded content.
 * <ul>
 ...
 *   <li>Use <code>setContentType(String[])</code> to set the file types that will be accepted (setting no types implies that all types are accepted).</li>
 * </ul>
 *  </p>
