package com.github.dibp.wcomponents.examples.validation.fields;
...
import com.github.dibp.wcomponents.WConfirmationButton;
...
import com.github.dibp.wcomponents.WPrintButton;
...
import com.github.dibp.wcomponents.validator.DateFieldPivotValidator;
...
public class CoreFields extends WPanel
{
    ...
    public CoreFields()
    {
        ...
        buttons.setMargin(new com.github.dibp.wcomponents.Margin(12, 0, 0, 0));
    ...
    /**
     * used to ensure that the fieldset holding the radio button group is 
     * highlighted rather than the individual buttons.  
     * 
