...
import com.github.dibp.wcomponents.ContentAccess;
...
import com.github.dibp.wcomponents.WContentLink;
...
import com.github.dibp.wcomponents.WContent.DisplayMode;
...
public class WContentExample extends WPanel
{
    ...
    public WContentExample()
    {
        ...
        addContentRow("View GIF",  new InternalResource("/com/github/dibp/wcomponents/examples/picker/wclogo_small.gif", "example.gif"), this);

        // Some content which browsers may be able to display using a plugin.
        addContentRow("View PDF",  new InternalResource("/com/github/dibp/wcomponents/examples/test.pdf", "example.pdf"), this);
        ...
        addContentRow("View TR5",  new InternalResource("/com/github/dibp/wcomponents/examples/test.tr5", "example.tr5"), this);
