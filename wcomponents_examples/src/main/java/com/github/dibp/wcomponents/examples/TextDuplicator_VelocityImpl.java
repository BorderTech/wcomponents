...
public class TextDuplicator_VelocityImpl extends WContainer
{
    ...
    public TextDuplicator_VelocityImpl(final String name)
    {
        ...
        // In this case, com.github.dibp.wcomponents.examples.TextDuplicatorPretty
        // maps to the template com/github/dibp/wcomponents/examples/TextDuplicator_VelocityImpl.vm
