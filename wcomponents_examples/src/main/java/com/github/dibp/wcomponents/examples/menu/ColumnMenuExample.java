...
import com.github.dibp.wcomponents.WSubMenu.MenuMode;
...
public class ColumnMenuExample extends WPanel
{
     ...
     * 
     * The data parameter should either contain a single String, 
     * or a String plus data arrays for child nodes.
     * 
