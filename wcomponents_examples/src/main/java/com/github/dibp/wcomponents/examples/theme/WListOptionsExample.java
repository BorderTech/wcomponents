...
import com.github.dibp.wcomponents.WList.Separator;

import com.github.dibp.wcomponents.examples.common.SimpleTableBean;
 ...
 * </ul>
 * </p><p>
 * also note: as at WComponents 6 the hidden tag has not been implemented in WList
 * this has been raised but as it is has not been raised by a project it has been 
 * placed on the todo pile.  
 * </p> 
 * 
 * @author Steve Harney
 * @since 1.0.0
...
public class WListOptionsExample extends WPanel
{
    ...
    private WFieldSet getListControls()
    {
        ...
        apply.setAction(new com.github.dibp.wcomponents.Action()
        {
    ...
    /**
     * Apply settings is responsible for building the list to be displayed and 
     * adding it to the container. 
     */
    private void applySettings()
    {
        container.reset();
        WList list = new WList((com.github.dibp.wcomponents.WList.Type) ddType.getSelected());
