...
import com.github.dibp.wcomponents.subordinate.And;
...
import com.github.dibp.wcomponents.validator.RegExFieldValidator;

import com.github.dibp.wcomponents.examples.validation.ValidationContainer;

/**
 * <p>This example demonstrates use of the SubordinateControl.</p>
 * 
 * <p>This example scenario involves a component (CardSelector) that
 * enables a user to enter a card type, where there are many different types
 * of card types with different validations. When the user switches between
 * types, the input field should update to match.</p>
 * 
 * <p>There are 2 instances of this CardSelector, the first one is
 * configured to use server side features to switch between card types,
 * the second one is configured to use client side switching.</p>
 * 
...
public class SubordinateControlExample extends ValidationContainer
{
    ...
    /**
     * Example of a wcomponent that uses SubordinateControl to handle its
     * visibility logic.
     */
    public static class CardSelector extends WPanel
    {
        ...
        private final Map<String, Input> mapOptionToField = new HashMap<String, Input>();
    ...
    /**
     * A Text field extension for entering an Visa Card number, which
     * ensures that the Card Number is in the correct format. 
     */
    ...
    /**
     * A Number field extension for entering a MasterCard, which
     * ensures that the CardType is in the correct format. 
     */
