 ...
 * {@link WDropdown}. When you change the selected state in the state dropdown, the
 * options available in the region dropdown are changed to match. Also, if you
 * select "ACT", you get a special message displayed. You should endeavour to
 * avoid this setting.
 * 
...
public class WDropdownSubmitOnChangeExample extends WContainer
{
    ...
    /**
     * Updates the options present in the region selector,
