...
/**
 * <p> This component demonstrates how to add some simple control logic, by
 * using Actions.</p>
 * 
 * <p>Buttons can be given actions. If the button is pressed, then the action
 * supplied will be executed.</p>
 * 
